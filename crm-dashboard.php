<?php
// error_log("DEBUG: crm-dashboard.php loaded.");

if (session_status() == PHP_SESSION_NONE) {
    session_start();
    // error_log("DEBUG: Session started in crm-dashboard.php");
}

// error_log("DEBUG: Before check-persistent-login.php include. Session ID: " . session_id());
require_once 'check-persistent-login.php';
// error_log("DEBUG: After check-persistent-login.php include. Session ID: " . session_id());

// Add debug output for session variables
// error_log("DEBUG: Session variables in crm-dashboard.php: " . print_r($_SESSION, true));
// error_log("DEBUG: Cookie 'persistent_login': " . (isset($_COOKIE['persistent_login']) ? $_COOKIE['persistent_login'] : 'Not set'));

// Check if user is NOT logged in
if (!isset($_SESSION['is_logged_in']) || $_SESSION['is_logged_in'] !== true) {
    // error_log("DEBUG: User NOT logged in. Redirecting to new-login.php");
    ?>
    <!DOCTYPE html>
    <html lang="en">
    <head>
...
// Fetch wallet name and user ID from DB based on user_id in session
...
// We know user is logged in at this point, so $_SESSION['user_id'] should be set by set-session.php
