...
function shouldShowJPTopBar({
    displayAfterHours = 12
} = {}) {
    const {
        region = '', locale = '', isLoggedIn
    } = bnvelidate || {}
            ...
            getGetHeaderI18n().then(function(getHeaderI18n) {
                showModal({
                    ...
                    afterDisplayIntervalCheck: function() {
                        ...
                        track('ComponentShow', {
                            $element_id: 'binance_hk_compliance_popup'
                        })
                    },
                    getHeaderI18n,
                })
