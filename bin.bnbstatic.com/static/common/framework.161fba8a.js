! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "52219589-c13b-5ac0-a558-ceefd7495822")
    } catch (e) {}
}();
    ...
    [6593], {
        ...
        wcIl: (t, e, n) => {
                        ...
                        if (0 === n.type) e || (d += "/"), d += n.value.replace(a, "\\$&"), s += 40;
                            ...
                            if (l !== r) {
                                ...
                                try {
                                    ...
                                    throw new Error(`Invalid custom RegExp for param "${t}" (${l}): ` + v.message)
                                }
                            }
                            let h = i ? `((?:${l})(?:/(?:${l}))*)` : `(${l})`;
            ...
            function E(t, e = "/") {
                ...
                if ("string" === typeof t) {
                    ...
                    ["pathname", "search", "hash", "query"].forEach((t => {
                        const r = e[t];
                        null != r && (n[t] = r)
                    })), n.search ? n.query = x(n.search) : n.search = v.stringify(n.query)
                }
                const r = n.pathname;
            ...
            class H {
                constructor({
                    ...
                    this.action = N, this.location = C("/"), this.doTransition = () => {}, this._index = 0, this._blockers = d(), this.basename = w(t)
                }
                back() {
                    this.go(-1)
                }
            ...
            function q(t, e = !1) {
                return t.map((t => {
                    ...
                    return t.children && (r.children = q(t.children, !0)), r
                }))
            }
            const Y = {
                matches: [],
            ...
            class z {
                constructor({
                    ...
                    this._pending = null, this._cancleHandler = null, this._ready = !1, this._readyDefer = (0, G.r)(), this._listeners = d(), this._beforeEachs = d(), this._beforeResolves = d(), this._afterEachs = d(), this.init = () => {
                        ...
                        this._ready && (this._ready = !1, this._readyDefer = (0, G.r)()), this._cancleHandler && (this._cancleHandler(), this._cancleHandler = null), this._routes = q(t), this._current = Y;
                        const e = () => this._history.setup();
                        this._history.transitionTo(this._getCurrent(), {
                            onTransition: e,
                            onAbort: e
                        })
                    }, this._history = t, this._routes = q(e), this._current = Y, this._history.doTransition = this._doTransition.bind(this)
                }
                get ready() {
                ...
                _doTransition(t, e, n, r, o, s) {
                    ...
                    const d = () => {
                        this._cancleHandler = null, n && n(), this._ready || this._current === Y || (this._ready = !0, this._readyDefer.resolve())
                    };
                    this._pending = t;
                    let y = [];
                    ! function(t, e, n) {
        ...
        "2rPy": (t, e, n) => {
                ...
                c.useEffect((function() {
                    A.t.traceChild(R.name).stop(), t.beforeEach((function(t, e, r) {
                        var o, s = "".concat(e.pathname).concat(e.search),
                            ...
                            c = (o = {}, (0, C.A)(o, T.attrs.from.name, s), (0, C.A)(o, T.attrs.to.name, i), (0, C.A)(o, T.attrs.navigationId.name, a), o);
            ...
            var z = function(t, e, n, o) {
                ...
                K = new H;
            const W = new function t() {
                var e = this;
                (0, f.A)(this, t), this._isInitialRender = !0, this.renderApp = function(t) {
                    return z(e, [t], void 0, s().mark((function t(e) {
                        var n, r, o, c, l, h, f, d, y, g, v, m, _;
                        return s().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    if (n = e.appContainer, r = e.app, o = e.appData, c = this, l = this._isInitialRender, h = r.router, f = r.appComponent, d = r.setError, r.error, y = o.ssr, g = o.dynamicIds, v = y && l, m = f, !y || !l) {
                                        t.next = 13;
                                        break
                                    }
                                    return t.next = 11, Promise.all([B.A.preloadReady(g), h.ready]);
                                case 11:
                                    t.next = 17;
                                    break;
                                case 13:
                ...
                var e = function(t) {
                    return t.map((function(t) {
                        var n = Object.assign({}, t),
                            ...
                            s = n.__resolveWeak__,
                            i = n.children,
                            a = Q(n, ["__componentRawRequest__", "__import__", "__resolveWeak__", "children"]);
            ...
            function ot(t, e, n) {
                ...
                for (let a = 0; a < r.length; a++) {
                    ...
                    if (!(0, et.A)(t.params, null === e || void 0 === e ? void 0 : e.params)) {
                        s.push(...r.slice(a));
                        break
                    }
            ...
            var st = n("IJ96"),
                it = n.n(st);
            const at = "Symbol" in n.g && "iterator" in Symbol;
            ...
            function lt(t) {
                ...
                return at && (e[Symbol.iterator] = function() {
                    return e
                }), e
            }
            class ht {
                constructor(t) {
                    this._map = {}, t instanceof ht ? t.forEach(((t, e) => {
                        this.append(e, t)
                ...
                delete(t) {
                    delete this._map[ct(t)]
                }
                get(t) {
                    return t = ct(t), this.has(t) ? this._map[t] : null
                }
                has(t) {
                    return this._map.hasOwnProperty(ct(t))
                }
                set(t, e) {
                    this._map[ct(t)] = ut(e)
                }
                ...
                keys() {
                    const t = [];
                    return this.forEach(((e, n) => t.push(n))), lt(t)
                }
                value() {
                    const t = [];
                    return this.forEach((e => t.push(e))), lt(t)
                }
                entries() {
                    const t = [];
                    return this.forEach(((e, n) => t.push([n, e]))), lt(t)
                }
            }
            at && (ht.prototype[Symbol.iterator] = ht.prototype.entries);
            class ft {
                constructor(t, e, n = {}) {
                    this.__shuvi_resp_type__ = e, this.data = t, this.status = n.status || 200, this.statusText = n.statusText || "", this.headers = new ht(n.headers)
                }
            }
            ...
            function mt(t, e = 500, {
                ...
                throw it()(e >= 400 && e < 600, "status code should be 4xx and 5xx"), new ft({
                    error: !0,
                    fatal: n
                }, "raw", {
                    status: e,
            ...
            function bt(t, e, n) {
                return yt(this, void 0, void 0, (function*() {
                    ...
                    const o = yield gt(t.map((t => () => yt(this, void 0, void 0, (function*() {
                        const r = e[t.route.id];
                        if ("function" !== typeof r) return;
                        let o, s;
                        try {
                            const e = yield r(n);
                            void 0 === e ? s = new Error(`You defined a loader for route "${t.route.path}" but didn't return anything from your \`loader\` function. Please return a value or \`null\`.`) : o = new ft(e, "json")
                        } catch (i) {
                            0,
                            s = i
                        }
                    ...
                    for (let e = 0; e < o.length; e++) {
                        ...
                        it()(n.result, `loader function of route "${t[e].route.path}" should return a value`), r[s] = n.result.data
                    }
                    return r
                }))
            }
            ...
            class jt {
                constructor(t) {
                    ...
                    }), this._error = this._store.getModel(y, g), this._loader = this._store.getModel(Et.K, Et.l), this._getLoaders = t.getLoaders, this._appComponent = t.AppComponent, this._pluginManager = (0, St.EI)(), (0, St.H7)(this._pluginManager, t.plugins || [])
                }
                get router() {
                    return this._router
                }
            ...
            var Rt, Lt = function(t, e, n, o) {
                ...
                Nt = function(t) {
                    ...
                    var h = (0, At.aE)({
                        ...
                        f = (Rt = function(t) {
                            var e = this;
                            return new jt(Object.assign(Object.assign({}, t), {
                                getLoaders: function() {
                                    return kt(e, void 0, void 0, s().mark((function t() {
                                        var e;
                                        return s().wrap((function(t) {
                                            for (;;) switch (t.prev = t.next) {
                                                case 0:
                                                    return t.next = 2, Promise.all([n.e(6593), n.e(4596), n.e(7547), n.e(2641), n.e(4105), n.e(9736), n.e(1019), n.e(9625)]).then(n.bind(n, "ApmL"));
                                                case 2:
                    ...
                    return h.beforeResolve((function(t, e, n) {
                        return Lt(void 0, void 0, void 0, s().mark((function r() {
                            var o, a, c, u, l, h;
                            return s().wrap((function(r) {
                                for (;;) switch (r.prev = r.next) {
                                    case 0:
                                        ...
                                        return d = !1, p && Rt.setLoadersData(f), r.abrupt("return", n());
                                    case 4:
                                        if (t.matches.length) {
                                            r.next = 8;
                                            break
                                        }
                                        return Rt.setError(i.nt.PAGE_NOT_FOUND), n(), r.abrupt("return");
                                    case 8:
                                        return o = A.t.traceChild(Dt.name), r.next = 11, Rt.getLoaders();
                                    case 11:
                                        return a = r.sent, c = ot(t, e, a), u = _t({
                                            pathname: t.pathname,
                                            query: t.query,
                                            params: t.params,
                                            ...
                                            rt(t).then(i).catch((function(t) {
                                                n(t)
                                            })), bt(c, a, u).then((function(t) {
                                                r = t, i()
                                            })).catch((function(t) {
                                                o = t, i()
                                            }))
                                    ...
                                    case 17:
                                        l = r.sent, Rt.setLoadersData(l), o.setAttribute(Dt.attrs.error.name, !1), o.stop(), r.next = 43;
                                        break;
                                    case 23:
                                        if (r.prev = 23, r.t0 = r.catch(14), o.setAttribute(Dt.attrs.error.name, !0), !dt(r.t0)) {
                                            r.next = 32;
                                            break
                                        }
                                        return h = r.t0.headers.get("Location"), Tt(h) ? window.location.replace(h) : n(h), o.setAttribute(Dt.attrs.errorType.name, "redirect"), o.stop(), r.abrupt("return");
                                    case 32:
                                    ...
                                    case 38:
                                        return o.setAttribute(Dt.attrs.errorType.name, "unexpectedError"), o.stop(), Rt.setError({
                                            message: i.nt.CLIENT_ERROR.message,
                                            error: r.t0
                                        }), n((function() {
                                            throw r.t0
                ...
                Ht = (0, Z.Y)(),
                $t = A.x.traceChild(p.ft.events.SHUVI_CLIENT_CREATE_APP.name).traceFn((function() {
                    return Nt({
                        appComponent: h,
                        routes: J.A,
                        appData: Ht
            ...
            window.__SHUVI ? window.__SHUVI.router = $t.router : window.__SHUVI = {
                router: $t.router
            }, Mt(void 0, void 0, void 0, s().mark((function t() {
                var e;
                return s().wrap((function(t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                        ...
                        case 3:
                            return t.next = 5, Mt(void 0, void 0, void 0, s().mark((function t() {
                                var e;
                                return s().wrap((function(t) {
                                    for (;;) switch (t.prev = t.next) {
                                        case 0:
                                            return e = document.getElementById(i.Kj), t.next = 3, W.renderApp({
                                                app: $t.getPublicAPI(),
                                                appData: Ht,
                                                appContainer: e
                                            });
        ...
        "14bH": (t, e, n) => {
            ...
            function f(t, e) {
                ...
                return t.match(e).forEach((({
                    ...
                    n[t] && n[t].map((e => {
                        ...
                        e.endsWith(".js") ? o.push(n) : e.endsWith(".css") && s.push(n)
                    }))
                })), {
                    js: o,
                    css: s
            ...
            function g(t) {
                var e = t.rootRef,
                    ...
                    h = l[0],
                    f = l[1],
                    g = (0, u.useCallback)((function(t) {
                        s.current && (s.current(), s.current = void 0), o || a || t && t.tagName && (s.current = function(t, e, n) {
                            var r = function(t) {
                                    var e, n = {
                                            root: t.root || null,
                                            margin: t.rootMargin || ""
                                    ...
                                    r ? e = v.get(r) : (e = v.get(n), m.push(n));
                                    if (e) return e;
                                    var o = new Map,
                                ...
                                s = r.observer,
                                i = r.elements;
                            return i.set(t, e), s.observe(t),
                                function() {
                                    if (i.delete(t), s.unobserve(t), 0 === i.size) {
                                        s.disconnect(), v.delete(o);
            ...
            function E(t, e, n) {
                return new Promise((function(r, o) {
                    ...
                    n && (i.as = n), i.rel = "prefetch", i.onload = r, i.onerror = o, i.dataset.id = e, i.href = t, document.head.appendChild(i)
                }))
            }
            ...
            var j = function(t) {
                var e, n = t.to,
                    ...
                    S = u.useCallback((function(t) {
                        f && p.current !== n && (m(), p.current = n), f && !1 !== i && y(t), r && ("function" === typeof r ? r(t) : "object" === typeof r && (r.current = t))
                    }), [n, f, i, m, y, r]);
                u.useEffect((function() {
                    f && !1 !== i && v && !x[n] && (O(_, n), x[n] = !0)
                }), [n, i, v]);
                var E = {
                    ref: S,
                    onMouseEnter: function(t) {
                        "function" === typeof a && a(t), f && !x[n] && (O(_, n), x[n] = !0)
                    }
                };
        ...
        "0GOp": t => {
            var e = function(t) {
                ...
                return v.prototype = m, c(x, "constructor", m), c(m, "constructor", v), v.displayName = c(m, a, "GeneratorFunction"), t.isGeneratorFunction = function(t) {
                    var e = "function" === typeof t && t.constructor;
                    return !!e && (e === v || "GeneratorFunction" === (e.displayName || e.name))
                }, t.mark = function(t) {
                    return Object.setPrototypeOf ? Object.setPrototypeOf(t, m) : (t.__proto__ = m, c(t, a, "GeneratorFunction")), t.prototype = Object.create(x), t
                }, t.awrap = function(t) {
                    return {
                        __await: t
                    }
        ...
        VyXn: (t, e, n) => {
            ...
            const r = () => {},
                ...
                v = t => "string" === typeof t && "NaN" !== t && "-" !== t[0] && "" + parseInt(t, 10) === t,
                m = (t, e) => Object.is(t, e),
                _ = (t, e, n) => {
            ...
            class Y {
                constructor(t, e = null, n) {
                    this.fn = t, this.scheduler = e, this.id = q++, this.deps = [], this.active = !0, this.parent = void 0,
                        function(t, e = R) {
                ...
                run() {
                    ...
                    try {
                        return this.parent = F, F = this, K = !0, V = 1 << ++U, U <= 30 ? (({
                            deps: t
                        }) => {
                            if (t.length)
                        ...
                        U <= 30 && (t => {
                            ...
                            if (e.length) {
                                ...
                                for (let r = 0; r < e.length; r++) {
                                    const o = e[r];
                                    N(o) && !M(o) ? o.delete(t) : e[n++] = o, o.w &= ~V, o.n &= ~V
                                }
                                e.length = n
                            }
                        })(this), V = 1 << --U, F = this.parent, K = e, this.parent = void 0, this.deferStop && this.stop()
                    }
                }
                stop() {
            ...
            function tt(t) {
                let e = !1;
                U <= 30 ? M(t) || (t.n |= V, e = !N(t)) : e = !t.has(F), e && (t.add(F), F.deps.push(t))
            }
            ...
            function nt(t, e, n, r, o) {
                ...
                if (i)
                    ...
                    case "add":
                        h(a) ? v(n) && c.push(i.get("length")) : (c.push(i.get(B)), f(a) && c.push(i.get(G)));
                        break;
                    case "delete":
                        h(a) || (c.push(i.get(B)), f(a) && c.push(i.get(G)));
                        break;
                    case "set":
                        f(a) && c.push(i.get(B))
                }
            ...
            function pt() {
                return function(t, e, n) {
                    ...
                    return (d(e) ? at.has(e) : it.has(e)) ? o : (X(t, 0, e), c(r, e) ? (t.disposed || !y(o) || (C(o) || (ct(t), o = t.copy[e] = Pt(o, t)), Q(o)), o) : o)
                }
            }
            ...
            function dt() {
                return function(t, e, n, r) {
                    const o = I(t),
                        s = ut(o, e),
                        i = h(o) && v(e) ? Number(e) < o.length : c(o, e);
                    if (!t.modified) {
                        const r = null === s || void 0 === s ? void 0 : s.__r_state;
                        if (r && r.base === n) return t.copy[e] = n, !0;
                        if (m(n, s) && (void 0 !== n || c(t.base, e))) return !0;
                        ct(t), T(t)
                    }
                    return m(t.copy[e], n) && (void 0 !== n || e in t.copy) || (t.copy[e] = n, t === P(r) && (i ? m(n, s) || nt(t, "set", e, n) : nt(t, "add", e, n), function(t) {
                        let e = t;
            ...
            function mt(t) {
                ...
                let r = n.get(t);
                return y(r) ? (C(r) || (vt(e), r = Pt(r, e), e.copy.set(t, r)), Q(r), r) : r
            }
            ...
            function _t(t, e) {
                const n = this.__r_state,
                    ...
                    s = r.get(t),
                    i = () => {
                        vt(n), T(n), n.copy.set(t, e)
                    };
                return o ? m(e, s) || (i(), nt(n, "set", t, e)) : (i(), nt(n, "add", t, e)), this
            }
            ...
            function St() {
                const t = this.__r_state,
                    ...
                    n = 0 !== e.size,
                    r = e.clear();
                return n && (vt(t), T(t), t.copy.clear(), nt(t, "clear", void 0, void 0)), r
            }
                ...
                const t = {
                    ...
                    forEach(t, e) {
                        ...
                        1 === n.type ? function(t, e, n, r) {
                            X(e, 0, B), I(e).forEach(((o, s) => n.call(r, e.proxy.get(s), s, t)))
            ...
            function Pt(t, e) {
                ...
                return o.proxy = i, e ? (o.root = e.root, e.children.push(o)) : o.root = o, Ct.set(o, i), o.proxy
            }
            ...
            const Dt = i({
                ...
                Mt = ({
                    ...
                    return c(a, e) ? 1 !== i && (a[e] = n, !0) : !c(o, e) && (!c(s, e) && ("$state" === e ? "bigint" !== typeof n && "symbol" !== typeof n && (t.replace(n), !0) : ("$" !== e[0] || !c(Dt, e)) && (r[e] = n, !0)))
                },
                Ht = {
                    get: Nt(!1),
                    set: Mt
            ...
            function te(t) {
                Bt.length && Bt.includes(t, Vt && t.allowRecurse ? Gt + 1 : Gt) || t === Qt || (null == t.id ? Bt.push(t) : Bt.splice(function(t) {
                    let e = Gt + 1,
                        n = Bt.length;
                    for (; e < n;) {
                        const r = e + n >>> 1;
                    ...
                    return e
                }(t.id), 0, t), Vt || Ft || (Ft = !0, Xt = Zt.then(oe)))
            }
            ...
            function ne(t, e = null) {
                if (qt.length) {
                    for (Qt = e, Yt = [...new Set(qt)], qt.length = 0, zt = 0; zt < Yt.length; zt++) Yt[zt]();
                ...
                try {
                    ...
                    Gt = 0, Bt.length = 0,
                        function(t) {
                            if (ne(), Kt.length) {
                                const t = [...new Set(Kt)];
                                if (Kt.length = 0, Wt) return void Wt.push(...t);
                                for (Wt = t, Wt.sort(((t, e) => re(t) - re(e))), Jt = 0; Jt < Wt.length; Jt++) Wt[Jt]();
                                Wt = null, Jt = 0
                            }
                        }(), Vt = !1, Xt = null, (Bt.length || qt.length || Kt.length) && oe(t)
                }
            }
            var se;
            ...
            class ce {
                constructor(t, {
                    ...
                    })), this._setState(this._initState), this.actions = Object.create(null), this.views = Object.create(null), this.accessContext = 0, this.ctx = {}, _(this.ctx, "_", this), this.accessCache = Object.create(null), this.proxy = new Proxy(this.ctx, Ht), this.publicInst = new Proxy(this.ctx, $t), this.effectScope = new L(o), this._initActions(), this._initViews()
                }
                patch(t) {
        ...
        "32oc": (t, e, n) => {
            ...
            if (e.Fragment = 60107, "function" === typeof Symbol && Symbol.for) {
                var s = Symbol.for;
                o = s("react.element"), e.Fragment = s("react.fragment")
            }
            ...
            function u(t, e, n) {
                var r, s = {},
                    u = null,
                    l = null;
                for (r in void 0 !== n && (u = "" + n), void 0 !== e.key && (u = "" + e.key), void 0 !== e.ref && (l = e.ref), e) a.call(e, r) && !c.hasOwnProperty(r) && (s[r] = e[r]);
                if (t && t.defaultProps)
...
//# debugId=52219589-c13b-5ac0-a558-ceefd7495822