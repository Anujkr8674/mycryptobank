! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "821da0f9-6915-53af-8670-cac6707c6e99")
    } catch (e) {}
}();
                        ...
                        if (null == r) {
                            ...
                            if ((p = "number" == typeof e) && 0 * e == 0) {
                                if (d.s = 1 / e < 0 ? (e = -e, -1) : 1, e === ~~e) {
                                    ...
                                    return void(c > x ? d.c = d.e = null : (d.e = c, d.c = [e]))
                                }
                                m = String(e)
                            } else {
                            ...
                            if (m = String(e), p = "number" == typeof e) {
                                ...
                                if (d.s = 1 / e < 0 ? (m = m.slice(1), -1) : 1, T.DEBUG && m.replace(/^0\.0*|\./, "").length > 15) throw Error(l + e)
                            } else d.s = 45 === m.charCodeAt(0) ? (m = m.slice(1), -1) : 1;
                            for (n = I.slice(0, r), c = a = 0, w = m.length; a < w; a++)
                            ...
                            p = !1, (c = (m = t(m, r, 10, d.s)).indexOf(".")) > -1 ? m = m.replace(".", "") : c = m.length
                        }
                        for (a = 0; 48 === m.charCodeAt(a); a++);
                        for (w = m.length; 48 === m.charCodeAt(--w););
                        if (m = m.slice(a, ++w)) {
                            if (w -= a, p && T.DEBUG && w > 15 && (e > g || e !== f(e))) throw Error(l + d.s * e);
                            if ((c = c - a - 1) > x) d.c = d.e = null;
                            else if (c < P) d.c = [d.e = 0];
                            else {
                    ...
                    function F(e, r, n, t) {
                        ...
                        if (m) {
                            e: {
                                ...
                                if ((o = r - i) < 0) o += h,
                                s = r,
                                w = (l = m[g = 0]) / d[i - s - 1] % 10 | 0;
                                else if ((g = u((o + 1) / h)) >= m.length) {
                                    if (!t) break e;
                                    for (; m.length <= g; m.push(0));
                                    l = w = 0, i = 1, s = (o %= h) - h + 1
                                } else {
                                    for (l = c = m[g], i = 1; c >= 10; c /= 10, i++);
                                    w = (s = (o %= h) - h + i) < 0 ? 0 : l / d[i - s - 1] % 10 | 0
                                }
                                if (t = t || r < 0 || null != m[g + 1] || (s < 0 ? l : l % d[i - s - 1]), t = n < 4 ? (w || t) && (0 == n || n == (e.s < 0 ? 3 : 2)) : w > 5 || 5 == w && (4 == n || t || 6 == n && (o > 0 ? s > 0 ? l / d[i - s] : 0 : m[g - 1]) % 10 & 1 || n == (e.s < 0 ? 8 : 7)), r < 1 || !m[0]) return m.length = 0, t ? (r -= e.e + 1, m[0] = d[(h - r % h) % h], e.e = -r || 0) : m[0] = e.e = 0, e;
                                if (0 == o ? (m.length = g, c = 1, g--) : (m.length = g + 1, c = d[h - o], m[g] = s > 0 ? f(l / d[i - s] % d[s]) * c : 0), t)
                                    for (;;) {
                                        if (0 == g) {
                    ...
                    return T.clone = e, T.ROUND_UP = 0, T.ROUND_DOWN = 1, T.ROUND_CEIL = 2, T.ROUND_FLOOR = 3, T.ROUND_HALF_UP = 4, T.ROUND_HALF_DOWN = 5, T.ROUND_HALF_EVEN = 6, T.ROUND_HALF_CEIL = 7, T.ROUND_HALF_FLOOR = 8, T.EUCLID = 9, T.config = T.set = function(e) {
                        ...
                        if (null != e) {
                            ...
                            if (e.hasOwnProperty(r = "CRYPTO")) {
                                ...
                                if (n) {
                                    if ("undefined" == typeof crypto || !crypto || !crypto.getRandomValues && !crypto.randomBytes) throw B = !n, Error(c + "crypto unavailable");
                                    B = n
                                } else B = n
                            }
                        ...
                        return function(e) {
                            ...
                            if (null == e ? e = _ : O(e, 0, m), o = u(e / h), B)
                                if (crypto.getRandomValues) {
                                    for (n = crypto.getRandomValues(new Uint32Array(o *= 2)); l < o;)(s = 131072 * n[l] + (n[l + 1] >>> 11)) >= 9e15 ? (t = crypto.getRandomValues(new Uint32Array(2)), n[l] = t[0], n[l + 1] = t[1]) : (a.push(s % 1e14), l += 2);
                                    l = o / 2
                                } else {
                                    if (!crypto.randomBytes) throw B = !1, Error(c + "crypto unavailable");
                                    for (n = crypto.randomBytes(o *= 7); l < o;)(s = 281474976710656 * (31 & n[l]) + 1099511627776 * n[l + 1] + 4294967296 * n[l + 2] + 16777216 * n[l + 3] + (n[l + 4] << 16) + (n[l + 5] << 8) + n[l + 6]) >= 9e15 ? crypto.randomBytes(7).copy(n, l) : (a.push(s % 1e14), l += 7);
                                    l = o / 7
                                }
                            if (!B)
                                for (; l < o;)(s = r()) < 9e15 && (a[l++] = s % 1e14);
                            for (o = a[--l], e %= h, o && e && (s = p[h - e], a[l] = f(o / s) * s); 0 === a[l]; a.pop(), l--);
                            if (l < 0) a = [i = 0];
                            else {
                        ...
                        return function(t, i, o, s, u) {
                            var f, c, l, a, h, g, p, w, m = t.indexOf("."),
                                d = _,
                                N = S;
                            for (m >= 0 && (a = U, U = 0, t = t.replace(".", ""), g = (w = new T(i)).pow(t.length - m), U = a, w.c = r(E(v(g.c), g.e, "0"), 10, o, e), w.e = w.c.length), l = a = (p = r(t, i, o, u ? (f = I, e) : (f = e, I))).length; 0 == p[--a]; p.pop());
                            if (!p[0]) return f.charAt(0);
                            if (m < 0 ? --l : (g.c = p, g.e = l, g.s = s, p = (g = n(g, w, d, N, o)).c, h = g.r, l = g.e), m = p[c = l + d + 1], a = o / 2, h = h || c < 0 || null != p[c + 1], h = N < 4 ? (null != m || h) && (0 == N || N == (g.s < 0 ? 3 : 2)) : m > a || m == a && (4 == N || h || 6 == N && 1 & p[c - 1] || N == (g.s < 0 ? 8 : 7)), c < 1 || !p[0]) t = h ? E(f.charAt(1), -d, f.charAt(0)) : f.charAt(0);
                            else {
                                if (p.length = c, h)
                        ...
                        return function(t, i, o, s, u) {
                            var c, l, g, p, w, m, v, N, O, b, y, E, A, _, S, R, D, P = t.s == i.s ? 1 : -1,
                                x = t.c,
                                B = i.c;
                            if (!x || !x[0] || !B || !B[0]) return new T(t.s && i.s && (x ? !B || x[0] != B[0] : B) ? x && 0 == x[0] || !B ? 0 * P : P / 0 : NaN);
                            for (O = (N = new T(P)).c = [], P = o + (l = t.e - i.e) + 1, u || (u = a, l = d(t.e / h) - d(i.e / h), P = P / h | 0), g = 0; B[g] == (x[g] || 0); g++);
                            if (B[g] > (x[g] || 0) && l--, P < 0) O.push(1), p = !0;
                            else {
                                ...
                                do {
                                    if (w = 0, (c = r(B, b, R, y)) < 0) {
                                        if (E = b[0], R != y && (E = E * u + (b[1] || 0)), (w = f(E / S)) > 1)
                                            for (w >= u && (w = u - 1), v = (m = e(B, w, u)).length, y = b.length; 1 == r(m, b, v, y);) w--, n(m, R < v ? D : B, v, u), v = m.length, c = 1;
                                        else 0 == w && (c = w = 1), v = (m = B.slice()).length;
                        ...
                        return function(o, s, u, f) {
                            var l, a = u ? s : s.replace(i, "");
                            if (t.test(a)) o.s = isNaN(a) ? null : a < 0 ? -1 : 1;
                            else {
                                if (!u && (a = a.replace(e, (function(e, r, n) {
                                        return l = "x" == (n = n.toLowerCase()) ? 16 : "b" == n ? 2 : 8, f && f != l ? e : r
                                    })), f && (l = f, a = a.replace(r, "$1").replace(n, "0.$1")), s != a)) return new T(a, l);
                                if (T.DEBUG) throw Error(c + "Not a" + (f ? " base " + f : "") + " number: " + s);
                                o.s = null
                            }
                            o.c = o.e = null
                        }
                        ...
                        var n, t, i, o, s, l, a, g, p = this;
                        if ((e = new T(e)).c && !e.isInteger()) throw Error(c + "Exponent not an integer: " + q(e));
                        ...
                        if (l = e.s < 0, r) {
                            ...
                            (t = !l && p.isInteger() && r.isInteger()) && (p = p.mod(r))
                        } else {
                            if (e.e > 9 && (p.e > 0 || p.e < -1 || (0 == p.e ? p.c[0] > 1 || s && p.c[1] >= 24e7 : p.c[0] < 8e13 || s && p.c[0] <= 9999975e7))) return o = p.s < 0 && b(e) ? -0 : 0, p.e > -1 && (o = 1 / o), new T(l ? 1 / o : o);
                            U && (o = u(U / h + 2))
                        }
                        for (s ? (n = new T(.5), l && (e.s = 1), a = b(e)) : a = (i = Math.abs(+q(e))) % 2, g = new T(A);;) {
                            if (a) {
                        ...
                        return t ? g : (l && (g = A.div(g)), r ? g.mod(r) : o ? F(g, U, S, undefined) : g)
                        ...
                        var f = s.e / h,
                            ...
                            g = e.c;
                        if (!f || !c) {
                            if (!l || !g) return l ? (e.s = -r, e) : new T(g ? s : NaN);
                            if (!l[0] || !g[0]) return g[0] ? (e.s = -r, e) : new T(l[0] ? s : 3 == S ? -0 : 0)
                        }
                        if (f = d(f), c = d(c), l = l.slice(), u = f - c) {
                            for ((o = u < 0) ? (u = -u, i = l) : (c = f, i = g), i.reverse(), r = u; r--; i.push(0));
                            i.reverse()
                        } else
                            for (t = (o = (u = l.length) < (r = g.length)) ? u : r, u = r = 0; r < t; r++)
                                if (l[r] != g[r]) {
                                    o = l[r] < g[r];
                                    break
                                } if (o && (i = l, l = g, g = i, e.s = -e.s), (r = (t = g.length) - (n = l.length)) > 0)
                            for (; r--; l[n++] = 0);
                        for (r = a - 1; t > u;) {
                            if (l[--t] < g[t]) {
                                for (n = t; n && !l[--n]; l[n] = r);
                        ...
                        return l[0] ? G(e, l, c) : (e.s = 3 == S ? -1 : 1, e.c = [e.e = 0], e)
                        ...
                        var n, t, i, o, s, u, f, c, l, g, p, m, v, N, O, b = this,
                            y = b.c,
                            E = (e = new T(e, r)).c;
                        ...
                        for (N = a, O = w, i = g; --i >= 0;) {
                            for (n = 0, p = E[i] % O, m = E[i] / O | 0, o = i + (s = f); o > i;) n = ((c = p * (c = y[--s] % O) + (u = m * c + (l = y[s] / O | 0) * p) % O * O + v[o] + n) / N | 0) + (u / O | 0) + m * l, v[o--] = c % N;
                            v[o] = n
                        }
                        ...
                        if (0 == (f = Math.sqrt(+q(s))) || f == 1 / 0 ? (((r = v(u)).length + c) % 2 == 0 && (r += "0"), f = Math.sqrt(+r), c = d((c + 1) / 2) - (c < 0 || c % 2), t = new T(r = f == 1 / 0 ? "5e" + c : (r = f.toExponential()).slice(0, r.indexOf("e") + 1) + c)) : t = new T(f + ""), t.c[0])
                            for ((f = (c = t.e) + l) < 3 && (f = 0);;)
                        ...
                        if (t = i.toFixed(e, r), i.c) {
                            ...
                            if (f && (o = u, u = f, f = o, w -= o), u > 0 && w > 0) {
                                for (o = w % u || u, a = p.substr(0, o); o < w; o += u) a += l + p.substr(o, u);
                                f > 0 && (a += l + p.slice(o)), g && (a = "-" + a)
                            }
                        ...
                        var r, t, i, o, s, u, f, l, a, g, w, m, d = this,
                            N = d.c;
                        if (null != e && (!(f = new T(e)).isInteger() && (f.c || 1 !== f.s) || f.lt(A))) throw Error(c + "Argument " + (f.isInteger() ? "out of range: " : "not an integer: ") + q(f));
                        if (!N) return new T(d);
                        for (r = new T(A), a = t = new T(A), i = l = new T(A), m = v(N), s = r.e = m.length - d.e - 1, r.c[0] = p[(u = s % h) < 0 ? h + u : u], e = !e || f.comparedTo(r) > 0 ? s > 0 ? r : a : f, u = x, x = 1 / 0, f = new T(m), l.c[0] = 0; g = n(f, r, 0, 1), 1 != (o = t.plus(g.times(i))).comparedTo(e);) t = i, i = o, a = l.plus(g.times(o = a)), l = o, r = f.minus(g.times(o = r)), f = o;
                        return o = n(e.minus(t), i, 0, 1), l = l.plus(o.times(a)), t = t.plus(o.times(i)), l.s = a.s = d.s, w = n(a, i, s *= 2, S).minus(d).abs().comparedTo(n(l, t, s, S).minus(d).abs()) < 1 ? [a, i] : [l, t], x = u, w
                    }, o.toNumber = function() {
                        return +q(this)
...
//# debugId=821da0f9-6915-53af-8670-cac6707c6e99