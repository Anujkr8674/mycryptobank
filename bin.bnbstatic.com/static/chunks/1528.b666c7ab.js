    ...
    [1528], {
        KlMB: (e, t, n) => {
            ...
            var c = n("mguP"),
                ...
                d = n("PzHQ");
            const f = function(e) {
                return l().createElement(d.A, (0, u._)({
                    width: "1em",
                    height: "1em",
                    viewBox: "0 0 24 24",
                    fill: "none"
            ...
            var k = function(e) {
                    ...
                    (0, p._)(this, n), (c = t.call(this, e)).index = 0, c.$refs = {}, c.state = {
                        ...
                        if (!c.unmount) {
                            var e = parseFloat(c.props.top),
                                ...
                                m = a.width,
                                u = o - s - e >= 0 && i - e <= 1,
                                d = c.simulate ? l.getBoundingClientRect() : {},
                                f = d.width,
                                p = d.left,
                                h = d.height,
                                x = c.simulate ? +(100 * f / m).toFixed(2) : 0;
                            c.setState({
                                sticky: u,
                                childRect: {
                                    left: p,
                ...
                return c.componentDidMount = function() {
                    ...
                    return l().createElement(l().Fragment, null, l().createElement(y, null), l().createElement("div", {
            ...
            var S = z(k.checkSticky, 16.66667);
            ...
            var J, Z, ee = function(e) {
                ...
                te = function(e) {
                    var t = e.checked,
                        ...
                        c = e.multiSelect,
                        r = void 0 === c || c,
                        a = (0, G._)(e, ["checked", "optionStr", "multiSelect"]);
                    return r ? l().createElement(i.A, (0, u._)({}, a, {
                        ...
                        children: t ? l().createElement(N.A, {
                            size: 16,
                            color: "bg1"
                        }) : null
                    }), l().createElement(o.A, {
                ...
                se = function() {
                    ...
                    return l().createElement(l().Fragment, null, l().createElement(o.A, {
                        as: "span",
                        children: F("cme-statement-pre", t)
                    }), l().createElement(o.A, {
                        as: "a",
                        target: "_blank",
                        ...
                        children: F("cme-statement-link", t)
                    }))
                },
                me = ["cme-idVerify-basic", "cme-idVerify-Advanced", "cme-idVerify-poa"],
                ue = (J = {}, (0, b._)(J, L.PROCESS, oe), (0, b._)(J, L.REFUSED, ie), (0, b._)(J, L.PASS, oe), J),
                de = (Z = {}, (0, b._)(Z, L.PROCESS, "primary"), (0, b._)(Z, L.REFUSED, "error"), (0, b._)(Z, L.PASS, "success"), Z);
            const fe = function(e) {
                var t = function() {
                    ...
                    h = p && d.every((function(e) {
                        return e.status === L.PASS
                    })),
                    x = f === L.PASS,
                ...
                return l().createElement(C.A, (0, u._)({}, e, {
                    ...
                    children: F("cme-idVerify-title", s)
                })), l().createElement(o.A, {
                    __css: {
                        mt: "xs",
                        mb: "sm"
                    ...
                    children: F("cme-idVerify-message", s)
                    ...
                    children: F("cme-idVerify-succ", s)
                })) : l().createElement(l().Fragment, null, me.map((function(e, t) {
                    var n = (d[t] || {}).status,
                        c = n === L.REFUSED,
                        r = 1 === t && n === L.PASS && !x,
                        a = r ? ae : ue[n] || oe,
                        m = r ? "primary" : de[n] || "t.third",
                        u = [F(e, s), r ? " (".concat(F("cme-idVerify-wckFail", s), ")") : "", c ? " ".concat(F("cme-idVerify-fail", s)) : ""].join("");
                    return l().createElement(i.A, {
                        key: t,
                        sx: {
                            color: "button.white",
                    ...
                    children: F("cme-idVerify-continue", s)
                })) : l().createElement(I.A, {
                    as: "a",
                    href: E,
                    children: F("cme-idVerify-go", s)
                }))
            };
            var pe = n("S+0I"),
                he = n("hrAD"),
            ...
            const Re = function() {
                            ...
                            a = (0, r.useCallback)((function() {
                                n((0, pe._)(ve().mark((function e() {
                                    ...
                                    return ve().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
                                                return o(Me), e.next = 3, (0, ze.post)("/bapi/kyc/v1/private/certificate/fixed/question/init", {
                                                    flowType: j
                                                });
                                            case 3:
                                ...
                                n((0, pe._)(ve().mark((function t() {
                                    ...
                                    return ve().wrap((function(t) {
                                        for (;;) switch (t.prev = t.next) {
                                            case 0:
                                                return t.next = 2, (0, ze.post)("/bapi/kyc/v1/private/certificate/fixed/question/skip", e);
                                            case 2:
                                                n = t.sent.data, o((function(e) {
                                                    return (0, xe._)((0, he._)({}, e), {
                                                        action: W,
                                                        actionResult: n && n.result ? K : U
                                                    })
                                                }));
                                            case 4:
                                            case "end":
                            ...
                            m = (0, r.useCallback)((function(e) {
                                n((0, pe._)(ve().mark((function t() {
                                    ...
                                    return ve().wrap((function(t) {
                                        for (;;) switch (t.prev = t.next) {
                                            case 0:
                                                return t.next = 2, (0, ze.post)("/bapi/kyc/v1/private/certificate/fixed/question/submit", e);
                                            case 2:
                                                n = t.sent.data, o((function(e) {
                                                    return (0, xe._)((0, he._)({}, e), {
                                                        action: Q,
                    ...
                    R = (0, r.useCallback)((function(e) {
                        ...
                        return function() {
                            n((function(e) {
                                ...
                                return (0, xe._)((0, he._)({}, e), (0, b._)({}, t, o))
                            }))
                        }
                    }), []),
                    q = T === x,
                ...
                if (l().useEffect((function() {
                        _ === W && A === K && f((function(e) {
                            return (0, xe._)((0, he._)({}, e), {
                                Questionnaire: D.SKIP
                            })
                        }))
                    }), [_, A]), _ === Q) {
                    if (A === K) return l().createElement(C.A, {
                        __css: {
                            p: "md",
                            bg: "popupBg"
                        },
                        ...
                        children: F("cme-ques-modal-succMsg", d)
                    }), l().createElement(o.A, {
                        sx: {
                            fontSize: 14,
                            mt: "xs",
                        ...
                        children: F("cme-ques-modal-succTip", d)
                    })), l().createElement(i.A, {
                        sx: {
                            alignItems: "center"
                        }
                        ...
                        children: F("cme-ques-modal-complete", d)
                    })));
                    if (A === U) return l().createElement(C.A, {
                        __css: {
                            p: "md",
                            bg: "popupBg"
                        },
                        ...
                        children: F("cme-ques-modal-failMsg", d)
                    }), l().createElement(o.A, {
                        sx: {
                            fontSize: 14,
                            mt: "xs",
                        ...
                        children: F("cme-ques-modal-failTip", d)
                    })), l().createElement(i.A, {
                        sx: {
                            alignItems: "center"
                        }
                        ...
                        children: F("cme-ques-modal-skip", d)
                    }), l().createElement(I.A, {
                        variant: "default",
                        disabled: q,
                        sx: {
                        ...
                        children: F("cme-ques-modal-reAnswer", d)
                    })))
                }
                return l().createElement(i.A, {
                    __css: {
                    ...
                    children: F("cme-ques-modal-title", d)
                }), l().createElement(o.A, {
                    sx: {
                        color: "t.secondary",
                        lineHeight: "20px"
                    },
                    children: F("cme-ques-modal-desc", d)
                })), l().createElement(C.A, {
                    __css: {
                        flex: 1,
                        p: "sm",
                ...
                }, x === T && l().createElement(ce, null), M.map((function(e, n) {
                    var c = e.questionId,
                        r = e.titleLangFlag,
                        a = e.options,
                        s = e.multiSelect,
                    ...
                    children: F("cme-ques-modal-submit", d)
                }))))
            };
            var qe = n("L6zS"),
                Pe = n("L/q1");
            const Be = function() {
                var e = B(),
                    ...
                    m = a[1],
                    u = function() {
                        var e = (0, c._)((0, Pe.A)(function() {
                            var e = (0, pe._)(ve().mark((function e(t) {
                                var n;
                                return ve().wrap((function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        case 0:
                                            return e.next = 2, (0, ze.post)("/bapi/kyc/v1/private/certificate/fixed/question/contract/check", t);
                                        case 2:
                                            return n = e.sent.data, e.abrupt("return", n && n.result ? K : U);
                                        case 4:
                                        case "end":
                                            return e.stop()
                                    }
                    ...
                    d = u.commitDisclaimer,
                    f = u.state,
                    p = f.loading,
                    h = f.value,
                    x = (0, r.useMemo)((function() {
                        return F("cme-disclaimer-content", t).split("|")
                    }), [t]);
                return l().useEffect((function() {
                    ...
                    children: F("cme-disclaimer-title", t)
                    ...
                    optionStr: F("cme-disclaimer-statement", t)
                }), l().createElement(i.A, {
                    sx: {
                        justifyContent: "center",
                        mt: "md"
                    ...
                    children: F("cme-disclaimer-submit", t)
                }))))
            };
            const Fe = function(e) {
                var t = B(),
                    ...
                    w = (0, r.useCallback)((function() {
                        E((0, pe._)(ve().mark((function e() {
                            ...
                            return ve().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        return e.next = 2, (0, ze.post)("/bapi/kyc/v1/private/certificate/fixed/question/skip", {
                                            flowType: j
                                        });
                                    case 2:
                ...
                return l().createElement(C.A, (0, u._)({}, e, {
                    ...
                    children: F("cme-ques-completed", n)
                    ...
                    children: F("cme-ques-reAnswer", n)
                }), l().createElement(I.A, {
                    variant: "quiet",
                    disabled: _,
                    onClick: w,
                    children: F("cme-ques-skip", n)
                    ...
                    children: F("cme-ques-noDisclaimer", n)
                })), l().createElement(I.A, {
                    onClick: function() {
                        return g(!0)
                    },
                    children: F("cme-ques-continue", n)
                })) : l().createElement(I.A, {
                    onClick: function() {
                        return g(!0)
                    },
                    children: F("cme-ques-start", n)
                }), z ? l().createElement(_e.Ay, null, l().createElement(a.A, {
                    theme: ge.A
                }, l().createElement(re, {
            ...
            var Le = n("O13v"),
                ...
                Ue = function(e) {
                    var t = e.lng,
                        ...
                        k = e.emit,
                        S = void 0 === k ? Oe : k,
                        b = (0, c._)((0, r.useState)(h || _), 2),
                        C = b[0],
                        I = b[1],
                        M = function(e) {
                            var t = e.i18nHost,
                                n = e.language,
                                c = (0, De.s)((0, pe._)(ve().mark((function e() {
                                    return ve().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
                                                return e.abrupt("return", (0, Le.TU)({
                                ...
                                a = (0, r.useCallback)((function() {
                                    n((0, pe._)(ve().mark((function e() {
                                        ...
                                        return ve().wrap((function(e) {
                                            for (;;) switch (e.prev = e.next) {
                                                case 0:
                                                    return e.prev = 0, e.next = 3, (0, ze.get)("/bapi/accounts/v2/private/country/user/restricted");
                                                case 3:
                    ...
                    return W && T.showCME ? l().createElement(j, {
                        top: "".concat(z)
                    }, l().createElement(a.A, {
                        theme: s.A
                    ...
                    }, K === O && l().createElement(ce, null), l().createElement(o.A, {
                        __css: {
                            flex: 1,
                            mr: [0, 0, 120]
                        },
        ...
        L6zS: (e, t, n) => {
            ...
            var c = n("b6CO"),
                ...
                i = n("PzHQ");
            const o = function(e) {
                return l().createElement(i.A, (0, c._)({
                    width: "1em",
                    height: "1em",
                    viewBox: "0 0 24 24",
                    fill: "none"
        ...
        i0BV: (e, t, n) => {
            ...
            var c = n("S+0I"),
                ...
                E = n("+K15");
            const v = function(e) {
                var t = (0, l._)((0, a.useState)(!1), 2),
                    n = t[0],
                    i = t[1],
                    v = (0, l._)((0, a.useState)({}), 2),
                    z = v[0],
                    g = v[1];
                (0, a.useEffect)((function() {
                    (0, c._)(o().mark((function t() {
                        var n, c, r, l, a;
                        return o().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    return t.next = 3, (0, h.get)("/bapi/apex/v1/friendly/apex/compliance/notification/display-detail?key=".concat(e.webKey, "&preCheck=true&currency=").concat(null === (n = x.U.read("userPreferredCurrency")) || void 0 === n ? void 0 : n.split("_")[0]));
                                case 3:
                                    c = t.sent, (r = c.data).length && (l = r[0], a = "".concat(e.prefix || "commonDialog", "_").concat(l.notificationId), 0 === l.intervalHours ? (i(!0), g(l)) : "y" !== E.IG.getExpireItem(a) && (E.IG.setExpireItem(a, "y", {
                                        ttl: 36e5 * l.intervalHours
                                    }), i(!0), g(l)));
                                case 6:
                                case "end":
                                    return t.stop()
                ...
                var _ = (0, a.useCallback)((function() {
                        i(!1), z.link && (window.location.href = z.link)
                    }), [z.link]),
                    A = (0, a.useCallback)((function() {
                        i(!1), z.secondLink && (window.location.href = z.secondLink)
                    }), [z.secondLink]);
                return s().createElement(s().Fragment, null, s().createElement(m.A, {
                    visible: n,
                    p: 4
                }, s().createElement(u.A, {
                    textAlign: "center"
                }, e.header || s().createElement(p.A, {
                    size: 80,
                    sx: {
                        mx: "auto"
                    }
                }), s().createElement(d.A, (0, r._)({
                    variant: "body2",
                    color: "t.primary",
                    width: ["250px", "312px"],
                    mt: 4,
                    ...
                    width: 1,
                    onClick: _
                }, z.secondText), z.thirdText && s().createElement(f.A, {
                    sz: "l",
                    variant: "text",
                    width: "100%",
                    onClick: A
