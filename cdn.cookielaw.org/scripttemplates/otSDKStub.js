var OneTrustStub = (t => {
    ...
    }(i = r = r || {}).ping = "ping", i.addEventListener = "addEventListener", i.removeEventListener = "removeEventListener", i.hasSection = "hasSection", i.getSection = "getSection", i.getField = "getField", i.getGPPData = "getGPPData";
    var m = new function() {
            var s = this;
    ...
    f.prototype.initConsentSDK = function() {
        ...
        "debug" !== this.buildType && "cybuild" !== this.buildType || (t.Version = "202503.2.0")
    };
    var A = f;
    ...
    function f() {
        ...
        this.iabType = null, this.iabTypeAdded = !0, this.crossOrigin = null, this.isAmp = !1, this.domainId = "", this.isReset = !1, this.isPreview = !1, this.geoFromUrl = "", this.nonce = "", this.setAttributePolyfillIsActive = !1, this.storageBaseURL = "", this.charset = null, this.buildType = "undefined", this.addBannerSDKScript = function(t) {
            var e = s.getRegionSet(t),
                i = (e.GCEnable || (s.updateGtmMacros(), s.gtmUpdated = !0), s.iabTypeAdded && ("IAB2" !== e.Type && "IAB2V2" !== e.Type || (s.iabType = e.Type, s.intializeIabStub()), "IAB2" !== e.Type) && "IAB2V2" !== e.Type && s.removeTcf(), e.IsGPPEnabled ? m.init() : m.removeGppApi(), l.stubScriptElement.cloneNode(!0)),
                n = "",
            ...
            d(n, "display: none;", !0), n.name = t, n.setAttribute("title", e + " Locator"), i.document.body.appendChild(n)
            ...
            var i, n;
            t && (n = !(i = {}), "IAB2" !== s.iabType && "IAB2V2" !== s.iabType || (i = {
    ...
    var E = new A;
    return t.OtSDKStub = A, t.otSdkStub = E, Object.defineProperty(t, "__esModule", {
        value: !0
    }), t
})({});