<div class="grid gap-x-[10px] gap-y-[16px] md:gap-x-[24px] md:gap-y-[24px] my-[16px] md:my-[24px] auto-rows-fr grid-cols-[repeat(auto-fit,minmax(160px,1fr))] md:grid-cols-[repeat(auto-fit,220px)]">
    <!-- Filter items for Algos -->
    <?php 
    $items = [
        [
            'class' => 'otc_trading_algo-hit-hidden',
            'link' => '/vip-portal/OTC-trading-platform?ref=OTC-Algo',
            'title' => 'Algo Order',
        ...
        [
            'class' => 'otc_trading_future_twap-hit-hidden',
            'link' => '/futures/BTCUSDC?orderType=TWAP',
            'title' => 'Futures TWAP',
