<div class="grid gap-x-[10px] gap-y-[16px] md:gap-x-[24px] md:gap-y-[24px] my-[16px] md:my-[24px] auto-rows-fr grid-cols-[repeat(auto-fit,minmax(160px,1fr))] md:grid-cols-[repeat(auto-fit,220px)]">
    <!-- Filter items for Sideways -->
    <?php 
    $items = [
        [
            'class' => 'Spot_Grid-hit-hidden',
            'link' => '/trading-bots/spot/grid/BTCUSDT',
            'title' => 'Spot Grid',
            'description' => 'Buy low and sell high 24/7 automatically with just one click.',
            'features' => ['Volatile Markets', 'Preset Ranges']
        ],
        [
            'class' => 'arbitrage_bot-hit-hidden',
            'link' => '/trading-bots/futures/arbitrage/BTCUSDT',
            'title' => 'Arbitrage Bot',
