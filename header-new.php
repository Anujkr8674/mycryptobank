...
<body>
  ...
  <div style="display: flex;" class="header1-logo">
  <a href="./en-IN.php"> <!-- ya "/" agar aap root URL dena chahte ho -->
    <img style="height: 70px;" src="./img/logo1.png" alt="Binance Logo" id="header1-logo-img" />
    ...
    <nav class="header1-nav">
      ...
      <div class="header1-header-actions">
        <div class="header1-icon-group">
          <button id="remove" class="header1-icon-btn header1-refresh-btn" title="Refresh page">🔄</button>
          <button id="remove"  class="header1-icon-btn">🌐</button>
        ...
        <div class="header1-auth-buttons">
          ...
          <a href="./signup-new.php">
            <button style=" background-color: yellow; color: black;"  class="header1-signup-btn">Sign Up</button>
          </a>
        </div>
      </div>
    </nav>
