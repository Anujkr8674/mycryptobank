/* @version 4.0.12-ci-ebc0f5ca7995b1afe6419c8c0087669eaccd35ba */ ! function(e, t) {
    ...
    return (() => {
        ...
        var He = function(e) {
            ...
            Ve = function() {
                return /electron/i.test(navigator.userAgent) ? Je.Electron : o.hybrid.isHybrid ? Je.Hybrid : Je.Web
            },
            $e = [];
        ...
        const gn = function(e) {
                ...
                if (!window.__PIKA_TRACK__ && n) {
                    ...
                    var m = mn({
                        ...
                        app_js_bridge: {
                            white_list: yn(new Set([null == v ? void 0 : v.server_url, "https://sensors.binance.cloud/sa?project=binance", "https://api.saasexch.com/bapi/fe/usd/sa?project=binance", "https://api.saasexch.cc/bapi/fe/usd/sa?project=binance", "https://api.saasexch.co/bapi/fe/usd/sa?project=binance"].filter(Boolean)))
                        },
                        show_log: !1,
                        heatmap: {
                            collect_tags: {
                    ...
                    if (h)
                        if (y) Object.assign(m, {
                            ...
                            Object.assign(m, {
                                sdk_url: "".concat(h, "/static/sensors/sensorsdata@").concat(g, ".js"),
