/*! For license information please see essential@0.3.39.js.LICENSE.txt */ ! function(e, t) {
    ...
    var e = {
            ...
            47: (e, t, r) => {
                ...
                ! function(i, o) {
                    ...
                    if (A && !A.ua) {
                        var O = new k;
                        A.ua = O.getResult(), A.ua.get = function() {
                            return O.getUA()
                        }, A.ua.set = function(e) {
                            O.setUA(e);
                            var t = O.getResult();
    ...
    return (() => {
        ...
        r.r(s), r.d(s, {
            _config: () => Ut,
            addRequestInterceptor: () => Ft,
            addResponseInterceptor: () => Gt,
            addResultInterceptor: () => Vt,
            del: () => br,
            fetch: () => or,
            fetchOrigin: () => Ue,
            get: () => hr,
        ...
        r.r(c), r.d(c, {
            config: () => $r,
            del: () => Wr,
            enableHTTPNextMode: () => Ur,
            enableLog: () => en,
            fetch: () => Gr,
            fetchOrigin: () => Xr,
            get: () => Vr,
            getDeviceInfo: () => Fr,
            getTracePageInSsr: () => Qr,
            initConfig: () => Zr,
            logAPI: () => tn,
            post: () => Hr,
            postForm: () => qr,
        ...
        function S(e, t) {
            return null == e || 0 === e.length ? e : (e = T(e), t = T(t), v(function(e, t) {
                var r, n, i, o, a, s, c = e.length,
                    u = c - 1;
                for (n = e[u], i = 0, s = 0 | Math.floor(6 + 52 / c); s > 0; --s) {
                    for (o = (i = y(i + b)) >>> 2 & 3, a = 0; a < u; ++a) r = e[a + 1], n = e[a] = y(e[a] + x(i, r, n, a, o, t));
                    r = e[0], n = e[u] = y(e[u] + x(i, r, n, u, o, t))
                }
                return e
            }(m(e, !0), _(m(t, !1))), !1))
        }
        ...
        var C = r(829),
            ...
            U = function(e, t) {
                ...
                if (j()) return r.ttl ? localStorage.setItem(e, JSON.stringify({
                    value: t,
            ...
            G = function() {
                var e = R,
                    t = null;
                t || (t = D[R]), document.cookie && (t = function(e) {
                    var t = (arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}).cookie,
                        r = "";
                    r = "undefined" == typeof document ? void 0 === t ? "" : t : document.cookie;
                    for (var n = "".concat(e, "="), i = r.split(";"), o = 0; o < i.length; o++) {
                        for (var a = i[o];
                            " " === a.charAt(0);) a = a.substring(1, a.length);
                        if (0 === a.indexOf(n)) return a.substring(n.length, a.length)
                    }
                    return null
                }(e)), !t && j() && (t = F(e) || null), !t && L() && (t = sessionStorage.getItem(e) || null);
                var r, n = M(t) || {};
                ...
                return t && function(e) {
                    ...
                    ! function(e) {
                        N(e, "", -1, !1)
                    }(t), N(t, r, 9999), j() && U(t, r), L() && sessionStorage.setItem(t, r), D[R] = r
                }(n), n
            },
            V = function() {
                return G()
            ...
            H = function(e) {
                ...
                return r.related_device_ids = o.map((function(e) {
                    return i[e].value
                })).join(","), P.Base64.encode(JSON.stringify(r))
            };
        ...
        function Y() {
            return q = q || (new X.UAParser).getResult()
        }
        var Q, ee = function() {
                var e = Y(),
                    t = e.browser,
                    r = e.os || {};
                return t && t.name ? "".concat(t.name, " V").concat(t.version, " (").concat(r.name || "", ")") : $
            },
            te = function(e) {
                ...
                try {
                    ...
                    return console.warn("Failed to get canvas code: ", e), I
                }
            },
            re = function(e) {
                var t = {
                ...
                for (var r = e.length, n = 0, i = 0; i < r; i++) {
                    var o = e[i] || "";
                    if (o.indexOf("webgl unmasked vendor:") > -1 ? (t.vendor = o.split("webgl unmasked vendor:")[1] || I, n += 1) : o.indexOf("webgl unmasked renderer:") > -1 && (t.renderer = o.split("webgl unmasked renderer:")[1] || I, n += 1), 2 === n) break
                }
                return t
            },
            ne = function(e) {
                ...
                return h().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            ...
                            break;
                        case 2:
                            if (t = "__BNC_FP_INFO__", r = W({}, J), !(n = M(F(t)))) {
                                e.next = 7;
                                break
                            }
                        ...
                        case 7:
                            return i = function() {
                                var e = O(h().mark((function e() {
                                    var n, i, o, a, s, c;
                                    return h().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
                                                return e.next = 2, Z().getPromise({
                                                    excludes: r
                                                });
                                            case 2:
                                                return n = e.sent, i = n.reduce((function(e, t) {
                                                    return e[t.key] = t.value, e
                                                }), {}), o = re(i.webgl), a = ie(i), s = {
                                                    screen_resolution: a.screenResolution,
                                                    available_screen_resolution: a.avaScreenResolution,
                                                    system_version: (void 0, h = Y().os, h && h.name ? "".concat(h.name, " ").concat(h.version) : $),
                                                    brand_model: (p = void 0, p = Y().device, p && p.model ? [p.type, p.vendor, p.model, ""].join(" ") : $),
                                                    ...
                                                    return s[e]
                                                })), s.fingerprint = Z().x64hash128(c.join(""), 32), localStorage.removeItem("__BNC_FP_INFO__0093cf"), U(t, JSON.stringify(s), {
                                                    ttl: 864e5
                                                }), e.abrupt("return", s);
                                            case 12:
                                            case "end":
        ...
        function ke(e) {
            ...
            var o = null === (t = document) || void 0 === t || null === (r = t.documentElement) || void 0 === r || null === (n = r.getAttribute) || void 0 === n ? void 0 : n.call(r, "lang");
            return o || (new URLSearchParams(location.search).get("hl") || "en")
        }
        var Ae = !(null === (xe = window) || void 0 === xe || !xe.__RUN_BY_ELECTRON__),
            Oe = function(e) {
        ...
        function Re(e, t) {
            ...
            if (Oe(e)) {
                Ae && (t ? window.localStorage.setItem("APP_COOKIES_".concat(e), encodeURIComponent(t)) : window.localStorage.removeItem("APP_COOKIES_".concat(e)));
                var o, a, s = ["path=/"];
        ...
        const De = "object" == typeof globalThis && Me(globalThis) || Me(window) || "object" == typeof self && Me(self) || "object" == typeof r.g && Me(r.g) || function() {
            return this
        }() || {};
        var Le = function(e) {
                try {
                    ...
                    ! function(e, ...t) {
                        De.pika = (null == De ? void 0 : De.pika) || {}, De.pika.__REPORT_MONITOR_EVENTS__ = De.pika.__REPORT_MONITOR_EVENTS__ || [], De.pika.__REPORT_MONITOR_EVENTS__.push([e, ...t])
                    }({
                        data: {
                            event: {
        ...
        if (window.fetch && !window.__ESSENTIAL_FETCH_TAG__) {
            ...
            window.fetch = function() {
                ...
                var n, i, o = t[0],
                    ...
                    s = t[2],
                    c = Date.now();
                return Fe.apply(window, t).then((function(e) {
                    var t = Date.now();
                    return i = t - c, n = e, e
                })).catch((function(e) {
                    throw e
        ...
        var Ge = Ue().fetch,
            Ve = Ee().hybrid.isHybrid,
            He = "/bapi/composite/v2/public/common/config/stub/score",
            ze = "_acc_org",
            We = 432e5,
            qe = 0,
            Xe = [],
        ...
        function Je() {
            if (++qe, window._accelerate_http_failed && 2 === qe) {
                var e = rt(),
                    t = e.r,
                    r = e.o,
                    n = e.t;
                t || (window.localStorage.setItem(ze, JSON.stringify({
                    r: !0,
                    o: r,
                    t: n
        ...
        function $e(e, t) {
            return et(e), nt(e).then((function() {
                Ye(t) || Qe()
            })).catch((function() {
                window._accelerate_http_failed = !0, Je(), Qe()
            }))
        }

        function Ye(e) {
            return e && +new Date - e < We
        }

        function Qe() {
            var e = (Xe.push(window.location.origin), Xe);
            (function(e) {
                var t = 0;
                return new Promise((function(r, n) {
                    e.forEach((function(i) {
                        nt(i).then((function(e) {
                            r(e), ++t
                        })).catch((function() {
                            ++t === e.length && n()
                        }))
        ...
        function et(e) {
            e = it(e), window._ACCELERATE_ORIGIN = e
        }
        ...
        function tt(e) {
            ...
            var r = rt(),
                n = r.r;
            Ye(r.t) && n && (t.r = n), window.localStorage.setItem(ze, JSON.stringify(t))
        }

        function rt() {
            return JSON.parse(window.localStorage.getItem(ze) || "{}")
        }

        function nt(e) {
            return Ge("".concat(it(e)).concat(He, "?timestamp=").concat(+new Date)).then((function(e) {
        ...
        const at = ot,
            ...
            ut = ({
                ...
                "GET" !== t && "HEAD" !== t && (a.body = r), st(e, a).then((e => {
                    o({
                        response: e
                    })
                })).catch((e => {
            ...
            lt = /BNC\/([0-9.]+) \(([a-zA-Z]+) ([0-9.]+)\)/,
            dt = (e, t, r) => Object.defineProperty(e, t, {
                value: r
            }),
            ft = e => {
                if ("string" != typeof e) throw new TypeError("agent must be a string");
                ...
                if (t) {
                    const e = t[1];
                    dt(r, "bridgeVersion", e), dt(r, "clientType", t[2]), dt(r, "clientVersion", t[3]), dt(r, "isHybrid", !!e)
                }
                return r
            };
        let pt;
        ...
        class wt {
            ...
            _receiveCallback(e, t) {
                ...
                r && (delete this._callbacks[e], gt(r, t))
            }
            _receiveEvent(e, t) {
        ...
        class vt {
            ...
            create(e, t) {
                const r = function(e) {
                    return 0 === arguments.length ? pt || (pt = ft("undefined" != typeof navigator ? navigator.userAgent : "")) : ft(e)
                }(t);
                let n = this._default;
                return this._adapters.some((({
                    test: e,
                    adapter: t
                }) => !!e(r) && (n = t, !0))), e(new(n(wt)), r)
            }
        }
        ...
        const yt = e => class extends e {
                _setup() {
                    window.BardApp || (window.BardApp = mt({
                        callbackFromNative(e, t, r) {
                            window._BNC_BRIDGE_DEBUG_ && console.log(`[callbackFromNative] ${r} (callbackId: ${e})`), this._receiveCallback(e, ht(r))
                        },
                        eventFromNative(e, t) {
                            window._BNC_BRIDGE_DEBUG_ && console.log(`[eventFromNative] eventType:${e} (data: ${t})`), this._receiveEvent(e, ht(t))
                        }
            ...
            _t = window.webkit && window.webkit.messageHandlers || {},
            Tt = (e, t = {}) => {
                _t[e] && _t[e].postMessage(t)
            },
            St = e => class extends e {
                _setup() {
                    window.BNCBridge || (window.BNCBridge = mt({
                        receive(e) {
        ...
        const {
            ...
            return t.on = (e, t) => o(e, t), t.once = (e, t) => o(e, t, !0), t.off = function(e, t) {
                ...
                if (!Ct) return e ? Promise.reject(e) : Promise.resolve(r);
                if (e) {
                ...
                return "iOS" === Bt && "IMAGE" === r && "string" == typeof n && 0 === n.indexOf("data:image") && (t.image = n.split(",")[1] || ""), e.invoke("share", t).then((({
                    result: e = "UNKNOWN"
                }) => {
                ...
                code: e
            }))), t.isSupportDeeplink = t => Ct && "LT" !== function(e, t) {
                return function(e, t) {
                    if (e.join(".") === t.join(".")) return "EQ";
                    for (let r = 0; r < e.length; r++) switch (At(e[r], t[r])) {
                        case "EQ":
                            continue;
                        case "GT":
                            return "GT";
            ...
            }(Pt, "1.8.0") ? e.invoke("isSupportDeeplink", {
                deeplink: t
            }).then((({
                supported: e
        ...
        function Ft(e) {
            Ut.requestInterceptors.length >= jt || Ut.requestInterceptors.push(e)
        }

        function Gt(e) {
            Ut.responseInterceptors.length >= jt || Ut.responseInterceptors.push(e)
        }

        function Vt(e) {
            Ut.resultInterceptors.length >= jt || Ut.resultInterceptors.push(e)
        }
        var Ht = !1,
            zt = function(e) {
                Ht && console.error("[http] initConfig should only be called once.");
                try {
                    var t = e.accelerate;
                    t && function(e) {
                        ...
                        return !Ve && (r = it(r), i && (t = i, "[object Array]" === Object.prototype.toString.call(t)) && ~i.indexOf(window.location.hostname) && r && "string" == typeof r && /^(https?:)?\/\//.test(r) && "function" == typeof o)
                    }(t) && function(e) {
                        var t = e.defaultOrigin,
                            r = void 0 === t ? "" : t,
                            n = e.origins,
                            i = void 0 === n ? [] : n;
                        if (!Ve && "03N03N03N01G02T02K03202S03202U02W01G02U033031" !== function(e) {
                            ...
                            window.__accelerate_compoleted = !0, Xe = i;
                            var o = rt(),
                                a = o.o,
                                s = o.t;
                            a ? Ye(s) ? (et(a), nt(a).then((function() {})).catch((function() {
                                window._accelerate_http_failed = !0, Je(), Qe()
                            }))) : $e(r, s) : Ye(s) || $e(r, s)
                        }
                    }(t)
                } catch (e) {}
                Object.assign(Ut, e), Ht = !0
            },
            Wt = function(e, t) {
                var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "";
        ...
        function er(e) {
            return function() {
                ...
                return new Promise((function(n, i) {
                    ...
                    function s(e) {
                        Qt(o, n, i, a, s, "throw", e)
                    }
                    a(void 0)
                }))
            }
        }
        var tr = Ee().hybrid.isHybrid,
            rr = function() {
                var e = er(regeneratorRuntime.mark((function e(t, r) {
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return e.abrupt("return", Lt.fetch(t, r));
                            case 1:
                            case "end":
                                return e.stop()
                        }
        ...
        rr = rr.bind(window);
        var nr, ir, or = tr ? rr : window.fetch,
            ar = function() {
                var e = er(regeneratorRuntime.mark((function e(t) {
                    var r, n;
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                ...
                var e = er(regeneratorRuntime.mark((function e() {
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 2:
                                return e.next = 4, ue("".trim().toLowerCase());
                            case 4:
            ...
            cr = ((nr = Pe("bnc-uuid")) || Re("bnc-uuid", nr = Ne(), 1825, !0), nr),
            ur = function() {
                var e = er(regeneratorRuntime.mark((function e(t, r) {
                    ...
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return n = r.omitHeader, i = r.lang, o = r.headers, r.req, a = r.credentials, e.next = 3, sr();
                            case 3:
                                return s = e.sent, c = n ? {} : $t({
                                    lang: i || ke(),
                                    "X-UI-REQUEST-TRACE": t,
                                    "X-TRACE-ID": t,
                                    "BNC-UUID": cr,
                                    "Content-Type": "application/json"
                                }, s), n || tr || (c = Object.assign(c, {
                                    clienttype: "web"
                                })), tr || (u = Pe("BNC_FV_KEY_T") || "", c = Object.assign(c, {
                                    "FVIDEO-ID": Pe("BNC_FV_KEY") || "",
                                    "FVIDEO-TOKEN": u ? k(u) : "",
                                    "X-PASSTHROUGH-TOKEN": Pe("bnc-challenge-token") || "",
                                    "BNC-Location": Pe("BNC-Location") || ""
                                }), null !== (l = window.localStorage.getItem("BNC-Level") || null) && (c["BNC-Level"] = l)), d = {}, f = Ie(), p = {
                                    method: "GET",
                                    mode: "cors",
                                    headers: $t($t($t($t({}, c), d), o), f),
                                    credentials: a
                                }, e.abrupt("return", {
                                    opts: p
                                });
            ...
            lr = function(e) {
                var t = Pe("cr00");
                return e.headers = e.headers || {}, e.headers.csrftoken || (e.headers.csrftoken = w()(t || "")), e
            },
            dr = function(e) {
                var t, r, n = Ut.baseUrl,
                    i = Ut.accelerate,
                    o = i.checkAccelerable,
                    a = i.enbleSites;
                return "string" == typeof(t = window._ACCELERATE_ORIGIN || i.defaultOrigin) && (t = (r = t) ? /^https?:/.test(r) ? r : "https://".concat(r) : r), a && Array.isArray(a) && !~a.indexOf(window.location.hostname) && (t = ""), /^(https?:)?\/\//.test(e) ? e : !tr && t && "string" == typeof t && /^(https?:)?\/\//.test(t) && o && o(e) ? "".concat(t).concat(e) : n ? "".concat(n).concat(e) : tr ? "".concat(window.location.origin).concat(e) : "".concat(e)
            },
            fr = {},
            pr = function() {
                var e = er(regeneratorRuntime.mark((function e(t, r, n) {
                    var i, o, a, s, c, u, l, d, f, p, h, g, w, b, v, m, y, x, _, T, S, E, k, A, O, C, B, P;
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                o = Ut.requestInterceptors, a = Ut.responseInterceptors, s = Ut.resultInterceptors, c = Date.now(), u = (r || {}).body, l = Wt((null === (i = r) || void 0 === i ? void 0 : i.method) || "GET", t, u), e.prev = 4, t = dr(t), h = Xt(o), e.prev = 7, h.s();
                            case 9:
                                if ((g = h.n()).done) {
                                    e.next = 20;
                                    break
                            ...
                            case 28:
                                return m = tr ? rr : window.fetch, e.next = 31, m(t, r, !0);
                            case 31:
                                d = e.sent, y = Xt(a), e.prev = 33, y.s();
                            case 35:
                                if ((x = y.n()).done) {
                                    e.next = 42;
                                    break
                            ...
                            case 50:
                                return T = Date.now(), f = T - c, e.next = 54, ar(d);
                            case 54:
                                (E = d._bodyBlob) && (S = E.type);
                                try {
                                    (O = null === (k = d) || void 0 === k || null === (A = k.headers) || void 0 === A ? void 0 : A.get("content-type")) && (S = O)
                                } catch (e) {}
                            ...
                            case 84:
                                throw e.prev = 84, e.t3 = e.catch(4), fr[l] && (delete fr[l], console.warn("prefetch ".concat(l, " error"))), !tr && e.t3 && "TypeError" === e.t3.name && Ze(), tr || Le({
                                    opts: r,
                                    url: t,
                                    res: d,
                                    duration: f,
                    ...
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                ...
                                return i = fr[n], delete fr[n], e.abrupt("return", i);
                            case 5:
                                return r = r || {}, o = Ne(), e.next = 9, ur(o, lr(r));
                            case 9:
                                return a = e.sent, s = a.opts, e.abrupt("return", pr(t, s, r));
                            case 12:
                            case "end":
                                return e.stop()
                        }
            ...
            gr = function() {
                var e = er(regeneratorRuntime.mark((function e(t, r) {
                    ...
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                if (n = u.length > 2 && void 0 !== u[2] ? u[2] : {}, i = Wt("POST", t, JSON.stringify(qt(r))), !fr[i]) {
                                    e.next = 6;
                                    break
                                }
                                return o = fr[i], delete fr[i], e.abrupt("return", o);
                            case 6:
                                return a = Ne(), e.next = 9, ur(a, lr(n));
                            case 9:
                                return s = e.sent, c = s.opts, c = Object.assign(c, {
                                    method: "POST",
                                    body: JSON.stringify(r)
                                }), e.abrupt("return", pr(t, c, n));
                            case 13:
                            case "end":
                                return e.stop()
                        }
            ...
            wr = function() {
                var e = er(regeneratorRuntime.mark((function e(t, r) {
                    ...
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return n = s.length > 2 && void 0 !== s[2] ? s[2] : {}, i = Ne(), e.next = 4, ur(i, lr(n));
                            case 4:
                                return o = e.sent, a = o.opts, a = Object.assign(a, {
                                    method: "PUT",
                                    body: JSON.stringify(r)
                                }), e.abrupt("return", pr(t, a, n));
                            case 8:
                            case "end":
                                return e.stop()
                        }
                    ...
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 4:
                                ...
                                return e.abrupt("return");
                            case 7:
                                return s = Wt(o, t, "GET" === o ? "" : JSON.stringify(qt(a))), fr[s] = "GET" === o ? hr(t, r) : gr(t, a, r), e.abrupt("return", fr[s]);
                            case 10:
                            case "end":
                                return e.stop()
                        }
        ...
        function Er(e) {
            return function() {
                ...
                return new Promise((function(n, i) {
                    ...
                    function s(e) {
                        Sr(o, n, i, a, s, "throw", e)
                    }
                    a(void 0)
                }))
            }
        }(ir = window._bn_http_init) && ir[0] ? yr(ir[0]) : (window._bn_http_init = window._bn_http_init || [], window._bn_http_init.push = function(e) {
            return yr(e)
        });
        var kr = function() {
            ...
            Br = function() {
                var e = Er(regeneratorRuntime.mark((function e(t, r, n) {
                    ...
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return o = n.options || {}, a = Cr(o.headers), n.onlyFile ? i = t : ((i = new FormData).append(n.name, t), r && Object.entries(r).map((function(e) {
                                    return i.append(e[0], e[1])
                                }))), e.next = 5, Ar(n.action, _r(_r({}, o), {}, {
                                    method: kr(n.method),
                                    headers: a,
                                    body: i
                                }));
        ...
        var Dr = {
            ...
            Lr = function() {
                var e = Mr(regeneratorRuntime.mark((function e(t, r) {
                    var n;
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                if (r = Rr(Rr({}, Dr), r), e.prev = 1, r.fileSelected && r.fileSelected(t), n = function() {
                                        var e = Mr(regeneratorRuntime.mark((function e() {
                                            var n, i, o;
                                            return regeneratorRuntime.wrap((function(e) {
                                                for (;;) switch (e.prev = e.next) {
                                                    case 0:
                                                        if (e.prev = 0, n = Rr({}, r), !r.beforeUpload) {
                                                            e.next = 7;
                                                            break
                                                        }
                                                    ...
                                                    case 7:
                                                        return e.next = 9, Br(n.file || t, n.data, n);
                                                    case 9:
        ...
        var Fr = sr,
            ...
            Wr = function() {
                return br.apply(s, arguments)
            },
            qr = function() {
                return vr.apply(s, arguments)
            },
            Xr = function() {
                return Ue.apply(s, arguments)
            },
            Kr = !1,
            Zr = function() {
                Kr && console.error("[http] initConfig should only be called once."), Kr = !0;
                for (var e = arguments.length, t = new Array(e), r = 0; r < e; r++) t[r] = arguments[r];
                var n = (null == t ? void 0 : t[0]) || {},
                    i = n.requestInterceptor,
                    o = n.responseInterceptor,
                    a = n.resultInterceptor;
                return i && Ft(i), o && Gt(o), a && Vt(a), {}
            },
            Jr = function() {},
            $r = void 0,
            Yr = function() {},
            ...
            tn = function() {},
            rn = function() {
                return jr.apply(s, arguments)
            },
            nn = function() {
                return Lr.apply(s, arguments)
            },
            on = function(e) {
                function t() {
                    this.message = e
            ...
            sn = on("The string to be encoded contains characters out of range"),
            cn = "undefined" != typeof btoa ? function(e) {
                return btoa(e)
            } : function(e) {
                for (var t, r, n = String(e), i = "", o = 0, a = an; n.charAt(0 | o) || (a = "=", o % 1); i += a.charAt(63 & t >> 8 - o % 1 * 8)) {
                    if ((r = n.charCodeAt(o += 3 / 4)) > 255) throw new sn;
                    t = t << 8 | r
                }
                return i
            };
        const un = function(e) {
            ...
            ln = function(e) {
                return un(e).replace(/\+/g, "-").replace(/\//g, "_")
            };
        var dn = on("The string to be decoded is not correctly encoded"),
            fn = "undefined" != typeof atob ? function(e) {
                return atob(e)
            } : function(e) {
                var t = String(e).replace(/[=]+$/, "");
                if (t.length % 4 == 1) throw new dn;
                for (var r, n, i = "", o = 0, a = 0; n = t.charAt(a++); ~n && (r = o % 4 ? 64 * r + n : n, o++ % 4) ? i += String.fromCharCode(255 & r >> (-2 * o & 6)) : 0) n = an.indexOf(n);
                return i
            };
        const pn = function(e) {
                return function(e) {
            ...
            hn = function(e) {
                return pn(e.replace(/-/g, "+").replace(/_/g, "/"))
            };
        var gn = ".";
        ...
        function wn() {
            ...
            return r.length > 2 ? r.slice(-t).join(gn) : e
        }
        window.uuid = o, window.b2aSDK = u, window.MD5 = w();
        var bn = /^\/([^/]*)/;
        ...
        function yn(e) {
            var t;
            Re("lang", e, 365, !0, "High"), Re(mn, e, 180, !1);
            var r = new URL(window.location.href);
            (null === (t = r.pathname.match(bn)) || void 0 === t ? void 0 : t[1]) === vn().replace(/\//g, "") && (r.pathname = r.pathname.replace(bn, "")), r.searchParams.delete("hl"), window.location.href = r.href
        }
        var xn = {
                a: {
                    a: {
            ...
            _n = function(e) {
                ...
                e += "-";
                for (var t = xn, r = 0; r < e.length && (!0 !== (t = t[e.charAt(r)]) && void 0 !== t); r++);
                return !0 === t ? "rtl" : "ltr"
            };
        ...
        var Sn = ["utm_content", "utm_medium", "utm_source", "utm_campaign"],
            En = {
                utm_content: "bu_c",
                utm_medium: "bu_m",
                utm_source: "bu_s",
        ...
        function An() {
            var e = {};
            try {
                if (e = Cn(), Object.keys(e).length > 0) return On(), e;
        ...
        function On() {
            try {
                var e = Cn();
                Object.keys(e).length > 0 && Sn.forEach((function(t) {
                    var r = e[t];
                    r ? kn.write(t, r) : kn.erase(t)
                }))
            } catch (e) {
