/*! For license information please see essential@0.3.42.js.LICENSE.txt */ ! function(e, t) {
            ...
            47: (e, t, r) => {
                ...
                ! function(i, o) {
                    ...
                    var a = "function",
                        ...
                        A = function(e, t) {
                            if ("object" == typeof e && (t = e, e = o), !(this instanceof A)) return new A(e, t).getResult();
                    ...
                    if (k && !k.ua) {
                        var O = new A;
                        k.ua = O.getResult(), k.ua.get = function() {
                            return O.getUA()
                        }, k.ua.set = function(e) {
                            O.setUA(e);
                            var t = O.getResult();
    ...
    return (() => {
        ...
        r.r(c), r.d(c, {
            config: () => Yr,
            del: () => qr,
            enableHTTPNextMode: () => Fr,
            enableLog: () => tn,
            fetch: () => Vr,
            fetchOrigin: () => Kr,
            get: () => Hr,
            getDeviceInfo: () => Gr,
            getTracePageInSsr: () => en,
            initConfig: () => Jr,
            logAPI: () => rn,
            post: () => zr,
            postForm: () => Xr,
        ...
        var ke = !(null === (xe = window) || void 0 === xe || !xe.__RUN_BY_ELECTRON__),
            Oe = function(e) {
        ...
        function Re(e, t) {
            ...
            if (Oe(e)) {
                ke && (t ? window.localStorage.setItem("APP_COOKIES_".concat(e), encodeURIComponent(t)) : window.localStorage.removeItem("APP_COOKIES_".concat(e)));
                var o, a, s = ["path=/"];
        ...
        const {
            ...
            return t.on = (e, t) => o(e, t), t.once = (e, t) => o(e, t, !0), t.off = function(e, t) {
                ...
                return function(e, t) {
                    ...
                    for (let r = 0; r < e.length; r++) switch (kt(e[r], t[r])) {
                        case "EQ":
                            continue;
                        case "GT":
                            return "GT";
        ...
        var nr, ir, or = tr ? rr : window.fetch,
            ...
            ur = ((nr = Pe("bnc-uuid")) || Re("bnc-uuid", nr = Ne(), 1825, !0), nr),
            lr = function() {
                var e = er(regeneratorRuntime.mark((function e(t, r) {
                        ...
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 3:
                                return s = e.sent, c = n ? {} : $t({
                                    ...
                                    "FVIDEO-TOKEN": u ? A(u) : "",
                                    "X-PASSTHROUGH-TOKEN": localStorage.getItem("X-PASSTHROUGH-TOKEN") || Pe("bnc-challenge-token") || "",
                                    "BNC-Location": Pe("BNC-Location") || ""
                                }), null !== (l = window.localStorage.getItem("BNC-Level") || null) && (c["BNC-Level"] = l)), d = {}, f = Ie(), p = {
                                    method: "GET",
                                    mode: "cors",
                                    headers: $t($t($t($t($t({}, c), d), o), f), {}, {
                                        "BNC-Time-Zone": cr()
                                    }),
                                    credentials: a
                                }, e.abrupt("return", {
            ...
            hr = function() {
                var e = er(regeneratorRuntime.mark((function e(t, r, n) {
                    var i, o, a, s, c, u, l, d, f, p, h, g, w, b, v, m, y, x, _, T, S, E, A, k, O, C, B, P;
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                o = Ut.requestInterceptors, a = Ut.responseInterceptors, s = Ut.resultInterceptors, c = Date.now(), u = (r || {}).body, l = Wt((null === (i = r) || void 0 === i ? void 0 : i.method) || "GET", t, u), e.prev = 4, t = fr(t), h = Xt(o), e.prev = 7, h.s();
                            case 9:
                                if ((g = h.n()).done) {
                                    e.next = 20;
                                    break
                            ...
                            case 54:
                                ...
                                try {
                                    (O = null === (A = d) || void 0 === A || null === (k = A.headers) || void 0 === k ? void 0 : k.get("content-type")) && (S = O)
                                } catch (e) {}
                            ...
                            case 84:
                                throw e.prev = 84, e.t3 = e.catch(4), pr[l] && (delete pr[l], console.warn("prefetch ".concat(l, " error"))), !tr && e.t3 && "TypeError" === e.t3.name && Ze(), tr || Le({
                                    opts: r,
                                    url: t,
                                    res: d,
                                    duration: f,
                    ...
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                ...
                                return i = pr[n], delete pr[n], e.abrupt("return", i);
                            case 5:
                                return r = r || {}, o = Ne(), e.next = 9, lr(o, dr(r));
                            case 9:
                                return a = e.sent, s = a.opts, e.abrupt("return", hr(t, s, r));
                            case 12:
                            case "end":
                                return e.stop()
                        }
            ...
            wr = function() {
                var e = er(regeneratorRuntime.mark((function e(t, r) {
                    ...
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                if (n = u.length > 2 && void 0 !== u[2] ? u[2] : {}, i = Wt("POST", t, JSON.stringify(qt(r))), !pr[i]) {
                                    e.next = 6;
                                    break
                                }
                                return o = pr[i], delete pr[i], e.abrupt("return", o);
                            case 6:
                                return a = Ne(), e.next = 9, lr(a, dr(n));
                            case 9:
                                return s = e.sent, c = s.opts, c = Object.assign(c, {
                                    method: "POST",
                                    body: JSON.stringify(r)
                                }), e.abrupt("return", hr(t, c, n));
                            case 13:
                            case "end":
                                return e.stop()
                        }
            ...
            br = function() {
                var e = er(regeneratorRuntime.mark((function e(t, r) {
                    ...
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return n = s.length > 2 && void 0 !== s[2] ? s[2] : {}, i = Ne(), e.next = 4, lr(i, dr(n));
                            case 4:
                                return o = e.sent, a = o.opts, a = Object.assign(a, {
                                    method: "PUT",
                                    body: JSON.stringify(r)
                                }), e.abrupt("return", hr(t, a, n));
                            case 8:
                            case "end":
                                return e.stop()
                        }
                    ...
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 4:
                                ...
                                return e.abrupt("return");
                            case 7:
                                return s = Wt(o, t, "GET" === o ? "" : JSON.stringify(qt(a))), pr[s] = "GET" === o ? gr(t, r) : wr(t, a, r), e.abrupt("return", pr[s]);
                            case 10:
                            case "end":
                                return e.stop()
                        }
        ...
        function Ar(e) {
            return function() {
                ...
                return new Promise((function(n, i) {
                    ...
                    function s(e) {
                        Er(o, n, i, a, s, "throw", e)
                    }
                    a(void 0)
                }))
            }
        }(ir = window._bn_http_init) && ir[0] ? xr(ir[0]) : (window._bn_http_init = window._bn_http_init || [], window._bn_http_init.push = function(e) {
            return xr(e)
        });
        var kr = function() {
            ...
            Pr = function() {
                var e = Ar(regeneratorRuntime.mark((function e(t, r, n) {
                    ...
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return o = n.options || {}, a = Br(o.headers), n.onlyFile ? i = t : ((i = new FormData).append(n.name, t), r && Object.entries(r).map((function(e) {
                                    return i.append(e[0], e[1])
                                }))), e.next = 5, Or(n.action, Tr(Tr({}, o), {}, {
                                    method: kr(n.method),
                                    headers: a,
                                    body: i
                                }));
            ...
            jr = function() {
                var e = Dr(regeneratorRuntime.mark((function e(t, r) {
                    ...
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                if (r = Ir(Ir({}, Lr), r), e.prev = 1, r.fileSelected && r.fileSelected(t), n = function() {
                                        var e = Dr(regeneratorRuntime.mark((function e() {
                                            var n, i, o;
                                            return regeneratorRuntime.wrap((function(e) {
                                                for (;;) switch (e.prev = e.next) {
                                                    case 0:
                                                        if (e.prev = 0, n = Ir({}, r), !r.beforeUpload) {
                                                            e.next = 7;
                                                            break
                                                        }
                                                    ...
                                                    case 7:
                                                        return e.next = 9, Pr(n.file || t, n.data, n);
                                                    case 9:
        ...
        var Gr = sr,
            ...
            Zr = !1,
            Jr = function() {
                Zr && console.error("[http] initConfig should only be called once."), Zr = !0;
                for (var e = arguments.length, t = new Array(e), r = 0; r < e; r++) t[r] = arguments[r];
            ...
            cn = an("The string to be encoded contains characters out of range"),
            un = "undefined" != typeof btoa ? function(e) {
                return btoa(e)
            } : function(e) {
                for (var t, r, n = String(e), i = "", o = 0, a = sn; n.charAt(0 | o) || (a = "=", o % 1); i += a.charAt(63 & t >> 8 - o % 1 * 8)) {
                    if ((r = n.charCodeAt(o += 3 / 4)) > 255) throw new cn;
                    t = t << 8 | r
                }
                return i
            };
        const ln = function(e) {
            ...
            dn = function(e) {
                return ln(e).replace(/\+/g, "-").replace(/\//g, "_")
            };
        var fn = an("The string to be decoded is not correctly encoded"),
            pn = "undefined" != typeof atob ? function(e) {
                return atob(e)
            } : function(e) {
                var t = String(e).replace(/[=]+$/, "");
                if (t.length % 4 == 1) throw new fn;
                for (var r, n, i = "", o = 0, a = 0; n = t.charAt(a++); ~n && (r = o % 4 ? 64 * r + n : n, o++ % 4) ? i += String.fromCharCode(255 & r >> (-2 * o & 6)) : 0) n = sn.indexOf(n);
                return i
            };
        const hn = function(e) {
                return function(e) {
            ...
            gn = function(e) {
                return hn(e.replace(/-/g, "+").replace(/_/g, "/"))
            };
        var wn = ".";
        ...
        function bn() {
            ...
            return r.length > 2 ? r.slice(-t).join(wn) : e
        }
        ...
        function xn(e) {
            var t;
            Re("lang", e, 365, !0, "High"), Re(yn, e, 180, !1);
            var r = new URL(window.location.href);
            (null === (t = r.pathname.match(vn)) || void 0 === t ? void 0 : t[1]) === mn().replace(/\//g, "") && (r.pathname = r.pathname.replace(vn, "")), r.searchParams.delete("hl"), window.location.href = r.href
        }
        var _n = {
                a: {
                    a: {
            ...
            Tn = function(e) {
                ...
                e += "-";
                for (var t = _n, r = 0; r < e.length && (!0 !== (t = t[e.charAt(r)]) && void 0 !== t); r++);
                return !0 === t ? "rtl" : "ltr"
            };
        ...
        var En = ["utm_content", "utm_medium", "utm_source", "utm_campaign"],
            An = {
                utm_content: "bu_c",
                utm_medium: "bu_m",
                utm_source: "bu_s",
        ...
        function On() {
            var e = {};
            try {
                if (e = Bn(), Object.keys(e).length > 0) return Cn(), e;
        ...
        function Cn() {
            try {
                var e = Bn();
                Object.keys(e).length > 0 && En.forEach((function(t) {
                    var r = e[t];
