/*! For license information please see essential@0.3.46.js.LICENSE.txt */ ! function(e, t) {
    ...
    var e = {
                    ...
                    n = function() {
                        var e = function(e, t) {
                            ...
                            U = [{
                                ...
                                key: "fontsFlash",
                                getData: function(e, t) {
                                    return M() ? D() ? t.fonts.swfPath ? void j((function(t) {
                                        e(t)
            ...
            989: e => {
                var t = function(e) {
                    ...
                    function A(e, r) {
                        var n = r.method,
                            i = e.iterator[n];
                        if (i === t) return r.delegate = null, "throw" === n && e.iterator.return && (r.method = "return", r.arg = t, A(e, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), w;
            ...
            47: (e, t, r) => {
                ...
                ! function(i, o) {
                    ...
                    if (A && !A.ua) {
                        var k = new O;
                        A.ua = k.getResult(), A.ua.get = function() {
                            return k.getUA()
                        }, A.ua.set = function(e) {
                            k.setUA(e);
                            var t = k.getResult();
                            for (var r in t) A.ua[r] = t[r]
                        }
                    }
                }(window)
            }
    ...
    return (() => {
        ...
        r.r(s), r.d(s, {
            ...
            addResponseInterceptor: () => Yt,
            addResultInterceptor: () => Qt,
            del: () => Tr,
            fetch: () => gr,
            fetchOrigin: () => Je,
            get: () => yr,
        ...
        r.r(c), r.d(c, {
            config: () => nn,
            del: () => $r,
            enableHTTPNextMode: () => Wr,
            enableLog: () => sn,
            fetch: () => Xr,
            fetchOrigin: () => Qr,
            get: () => Kr,
            getDeviceInfo: () => qr,
            getTracePageInSsr: () => an,
            initConfig: () => tn,
            logAPI: () => cn,
            post: () => Zr,
            postForm: () => Yr,
        ...
        var b = r(829),
            ...
            O = function(e, t) {
                ...
                if (E()) return r.ttl ? localStorage.setItem(e, JSON.stringify({
                    value: t,
            ...
            k = function(e) {
                ...
                }(t), E() && O(t, r), S() && sessionStorage.setItem(t, r), T[y] = r
            },
            C = function() {
                return function() {
                    var e = y,
                        t = null;
                    t || (t = T[y]), !t && E() && (t = A(e) || null), !t && S() && (t = sessionStorage.getItem(e) || null);
                    var r, n = _(t) || {};
                    if (r = n, "[object String]" === Object.prototype.toString.call(r)) {
                        console.log("device need decodeURIComponent");
                        try {
                            n = _(decodeURIComponent(n))
                        } catch (e) {
            ...
            B = function(e) {
                ...
                return r.related_device_ids = o.map((function(e) {
                    return i[e].value
                })).join(","), m.Base64.encode(JSON.stringify(r))
            };
        ...
        function U() {
            return I = I || (new N.UAParser).getResult()
        }
        var F, G = function() {
                var e = U(),
                    t = e.browser,
                    r = e.os || {};
                return t && t.name ? "".concat(t.name, " V").concat(t.version, " (").concat(r.name || "", ")") : L
            },
            V = function(e) {
                ...
                try {
                    ...
                    return console.warn("Failed to get canvas code: ", e), x
                }
            },
            H = function(e) {
                var t = {
                ...
                for (var r = e.length, n = 0, i = 0; i < r; i++) {
                    var o = e[i] || "";
                    if (o.indexOf("webgl unmasked vendor:") > -1 ? (t.vendor = o.split("webgl unmasked vendor:")[1] || x, n += 1) : o.indexOf("webgl unmasked renderer:") > -1 && (t.renderer = o.split("webgl unmasked renderer:")[1] || x, n += 1), 2 === n) break
                }
                return t
            },
            z = function(e) {
                ...
                return h().wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            ...
                            break;
                        case 2:
                            if (t = "__BNC_FP_INFO__", r = R({}, j), !(n = _(A(t)))) {
                                e.next = 7;
                                break
                            }
                        ...
                        case 7:
                            return i = function() {
                                var e = w(h().mark((function e() {
                                    var n, i, o, a, s, c;
                                    return h().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
                                                return e.next = 2, D().getPromise({
                                                    excludes: r
                                                });
                                            case 2:
                                                return n = e.sent, i = n.reduce((function(e, t) {
                                                    ...
                                                    system_version: (void 0, h = U().os, h && h.name ? "".concat(h.name, " ").concat(h.version) : L),
                                                    brand_model: (p = void 0, p = U().device, p && p.model ? [p.type, p.vendor, p.model, ""].join(" ") : L),
                                                    ...
                                                    return s[e]
                                                })), s.fingerprint = D().x64hash128(c.join(""), 32), localStorage.removeItem("__BNC_FP_INFO__0093cf"), O(t, JSON.stringify(s), {
                                                    ttl: 864e5
                                                }), e.abrupt("return", s);
                                            case 12:
                                            case "end":
        ...
        function ae(e, t) {
            return null == e || 0 === e.length ? e : (e = oe(e), t = oe(t), ee(function(e, t) {
                var r, n, i, o, a, s, c = e.length,
                    u = c - 1;
                for (n = e[u], i = 0, s = 0 | Math.floor(6 + 52 / c); s > 0; --s) {
                    for (o = (i = re(i + Q)) >>> 2 & 3, a = 0; a < u; ++a) r = e[a + 1], n = e[a] = re(e[a] + ne(i, r, n, a, o, t));
                    r = e[0], n = e[u] = re(e[u] + ne(i, r, n, u, o, t))
                }
                return e
            }(te(e, !0), ie(te(t, !1))), !1))
        }
        ...
        var ce = function(e) {
            ...
            ue = r(232);
        const le = /BNC\/([0-9.]+) \(([a-zA-Z]+) ([0-9.]+)\)/,
            de = (e, t, r) => Object.defineProperty(e, t, {
                value: r
            }),
            fe = e => {
                ...
                if (t) {
                    const e = t[1];
                    de(r, "bridgeVersion", e), de(r, "clientType", t[2]), de(r, "clientVersion", t[3]), de(r, "isHybrid", !!e)
                }
                return window.__NEZHA_BRIDGE__ && !window.__NEZHA_BRIDGE__.postAction && (r.isHybrid = !0), r
            };
        let pe;
        const he = () => "undefined" != typeof navigator ? navigator.userAgent : "";

        function ge(e) {
            return 0 === arguments.length ? pe || (pe = fe(he())) : fe(e)
        }
        ...
        function Se(e) {
            ...
            var n = ge(t),
                ...
                f = "desktop" === l,
                p = "tablet" === l,
                h = ve(ve({}, null == u ? void 0 : u.device), {}, {
                    type: l
                }),
                g = {
                    platform: {
        ...
        var Ee = !(null === (ye = window) || void 0 === ye || !ye.__RUN_BY_ELECTRON__),
            Oe = function(e) {
        ...
        function Be(e, t) {
            ...
            if (Oe(e)) {
                Ee && (t ? window.localStorage.setItem("APP_COOKIES_".concat(e), encodeURIComponent(t)) : window.localStorage.removeItem("APP_COOKIES_".concat(e)));
                var o, a, s = ["path=/"];
        ...
        function Re(e) {
            ...
            var a = null === (r = document) || void 0 === r || null === (n = r.documentElement) || void 0 === n || null === (i = n.getAttribute) || void 0 === i ? void 0 : i.call(n, "lang");
            return a || (new URLSearchParams(location.search).get("hl") || "en")
        }
        ...
        var Ue, Fe = Se().hybrid.isHybrid,
                ...
                var e = Le(regeneratorRuntime.mark((function e() {
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 2:
                                return e.next = 4, J("".trim().toLowerCase());
                            case 4:
            ...
            He = ((Ue = Ce("bnc-uuid")) || Be("bnc-uuid", Ue = Pe(), 1825, !0), Ue),
            ze = function() {
                var e = Le(regeneratorRuntime.mark((function e(t, r) {
                    var n, i, o, a, s, c, u, l, d, f, p;
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return n = r.omitHeader, i = r.lang, o = r.headers, r.req, a = r.credentials, e.next = 3, Ge();
                            case 3:
                                return s = e.sent, c = n ? {} : Me({
                                    lang: i || Re(),
                                    "X-UI-REQUEST-TRACE": t,
                                    "X-TRACE-ID": t,
                                    "BNC-UUID": He,
                                    "Content-Type": "application/json"
                                }, s), n || Fe || (c = Object.assign(c, {
                                    clienttype: "web"
                                })), Fe || (u = Ce("BNC_FV_KEY_T") || "", c = Object.assign(c, {
                                    "FVIDEO-ID": Ce("BNC_FV_KEY") || "",
                                    "FVIDEO-TOKEN": u ? ce(u) : "",
                                    "X-PASSTHROUGH-TOKEN": localStorage.getItem("X-PASSTHROUGH-TOKEN") || Ce("bnc-challenge-token") || "",
                                    "BNC-Location": Ce("BNC-Location") || ""
                                }), null !== (l = window.localStorage.getItem("BNC-Level") || null) && (c["BNC-Level"] = l)), d = {}, f = Ie(), p = {
                                    method: "GET",
                                    mode: "cors",
                                    headers: Me(Me(Me(Me(Me({}, c), d), o), f), {}, {
                                        "BNC-Time-Zone": Ve()
                                    }),
                                    credentials: a
                                }, e.abrupt("return", {
        ...
        const Xe = "object" == typeof globalThis && qe(globalThis) || qe(window) || "object" == typeof self && qe(self) || "object" == typeof r.g && qe(r.g) || function() {
            return this
        }() || {};
        var Ke = function(e) {
                try {
                    ...
                    ! function(e, ...t) {
                        Xe.pika = (null == Xe ? void 0 : Xe.pika) || {}, Xe.pika.__REPORT_MONITOR_EVENTS__ = Xe.pika.__REPORT_MONITOR_EVENTS__ || [], Xe.pika.__REPORT_MONITOR_EVENTS__.push([e, ...t])
                    }({
                        data: {
                            event: {
                                ...
                                res_header: Ze(null === (n = e.res) || void 0 === n ? void 0 : n.headers),
                                ct: e.duration,
        ...
        if (window.fetch && !window.__ESSENTIAL_FETCH_TAG__) {
            ...
            window.fetch = function() {
                ...
                var n, i, o = t[0],
                    ...
                    s = t[2],
                    c = Date.now();
                return $e.apply(window, t).then((function(e) {
                    var t = Date.now();
                    return i = t - c, n = e, e
                })).catch((function(e) {
                    throw e
        ...
        var Ye = Je().fetch,
            Qe = Se().hybrid.isHybrid,
            et = "/bapi/composite/v2/public/common/config/stub/score",
            tt = "_acc_org",
            rt = 432e5,
            nt = 0,
            it = [],
        ...
        function st() {
            if (++nt, window._accelerate_http_failed && 2 === nt) {
                var e = pt(),
                    t = e.r,
                    r = e.o,
                    n = e.t;
                t || (window.localStorage.setItem(tt, JSON.stringify({
                    r: !0,
                    o: r,
                    t: n
        ...
        function ct(e, t) {
            return dt(e), ht(e).then((function() {
                ut(t) || lt()
            })).catch((function() {
                window._accelerate_http_failed = !0, st(), lt()
            }))
        }

        function ut(e) {
            return e && +new Date - e < rt
        }

        function lt() {
            var e = (it.push(window.location.origin), it);
            (function(e) {
                var t = 0;
                return new Promise((function(r, n) {
                    e.forEach((function(i) {
                        ht(i).then((function(e) {
                            r(e), ++t
                        })).catch((function() {
                            ++t === e.length && n()
                        }))
        ...
        function dt(e) {
            e = gt(e), window._ACCELERATE_ORIGIN = e
        }
        ...
        function ft(e) {
            ...
            var r = pt(),
                n = r.r;
            ut(r.t) && n && (t.r = n), window.localStorage.setItem(tt, JSON.stringify(t))
        }

        function pt() {
            return JSON.parse(window.localStorage.getItem(tt) || "{}")
        }

        function ht(e) {
            return Ye("".concat(gt(e)).concat(et, "?timestamp=").concat(+new Date)).then((function(e) {
        ...
        const bt = wt,
            ...
            yt = ({
                ...
                "GET" !== t && "HEAD" !== t && (a.body = r), vt(e, a).then((e => {
                    o({
                        response: e
                    })
                })).catch((e => {
            ...
            xt = /BNC\/([0-9.]+) \(([a-zA-Z]+) ([0-9.]+)\)/,
            _t = (e, t, r) => Object.defineProperty(e, t, {
                value: r
            }),
            Tt = e => {
                if ("string" != typeof e) throw new TypeError("agent must be a string");
                ...
                if (t) {
                    const e = t[1];
                    _t(r, "bridgeVersion", e), _t(r, "clientType", t[2]), _t(r, "clientVersion", t[3]), _t(r, "isHybrid", !!e)
                }
                return r
            };
        let St;
        ...
        class At {
            ...
            _receiveCallback(e, t) {
                ...
                r && (delete this._callbacks[e], Ot(r, t))
            }
            _receiveEvent(e, t) {
        ...
        class Ct {
            ...
            create(e, t) {
                const r = function(e) {
                    return 0 === arguments.length ? St || (St = Tt("undefined" != typeof navigator ? navigator.userAgent : "")) : Tt(e)
                }(t);
                let n = this._default;
        ...
        const Pt = e => class extends e {
                _setup() {
                    window.BardApp || (window.BardApp = Bt({
                        callbackFromNative(e, t, r) {
                            window._BNC_BRIDGE_DEBUG_ && console.log(`[callbackFromNative] ${r} (callbackId: ${e})`), this._receiveCallback(e, Et(r))
                        },
                        eventFromNative(e, t) {
                            window._BNC_BRIDGE_DEBUG_ && console.log(`[eventFromNative] eventType:${e} (data: ${t})`), this._receiveEvent(e, Et(t))
                        }
            ...
            It = window.webkit && window.webkit.messageHandlers || {},
            Nt = (e, t = {}) => {
                It[e] && It[e].postMessage(t)
            },
            Mt = e => class extends e {
                _setup() {
                    window.BNCBridge || (window.BNCBridge = Bt({
                        receive(e) {
        ...
        const {
            ...
            return t.on = (e, t) => o(e, t), t.once = (e, t) => o(e, t, !0), t.off = function(e, t) {
                ...
                if (!Ft) return e ? Promise.reject(e) : Promise.resolve(r);
                if (e) {
                ...
                return "iOS" === Gt && "IMAGE" === r && "string" == typeof n && 0 === n.indexOf("data:image") && (t.image = n.split(",")[1] || ""), e.invoke("share", t).then((({
                    result: e = "UNKNOWN"
                }) => {
                ...
                code: e
            }))), t.isSupportDeeplink = t => Ft && "LT" !== function(e, t) {
                return function(e, t) {
                    if (e.join(".") === t.join(".")) return "EQ";
                    for (let r = 0; r < e.length; r++) switch (Lt(e[r], t[r])) {
                        case "EQ":
                            continue;
                        case "GT":
                            return "GT";
            ...
            }(Vt, "1.8.0") ? e.invoke("isSupportDeeplink", {
                deeplink: t
            }).then((({
                supported: e
        ...
        function $t(e) {
            Jt.requestInterceptors.length >= Zt || Jt.requestInterceptors.push(e)
        }

        function Yt(e) {
            Jt.responseInterceptors.length >= Zt || Jt.responseInterceptors.push(e)
        }

        function Qt(e) {
            Jt.resultInterceptors.length >= Zt || Jt.resultInterceptors.push(e)
        }
        var er = !1,
            tr = function(e) {
                er && console.error("[http] initConfig should only be called once.");
                try {
                    var t = e.accelerate;
                    t && function(e) {
                        ...
                        return !Qe && (r = gt(r), i && (t = i, "[object Array]" === Object.prototype.toString.call(t)) && ~i.indexOf(window.location.hostname) && r && "string" == typeof r && /^(https?:)?\/\//.test(r) && "function" == typeof o)
                    }(t) && function(e) {
                        var t = e.defaultOrigin,
                            r = void 0 === t ? "" : t,
                            n = e.origins,
                            i = void 0 === n ? [] : n;
                        if (!Qe && "03N03N03N01G02T02K03202S03202U02W01G02U033031" !== function(e) {
                            ...
                            window.__accelerate_compoleted = !0, it = i;
                            var o = pt(),
                                a = o.o,
                                s = o.t;
                            a ? ut(s) ? (dt(a), ht(a).then((function() {})).catch((function() {
                                window._accelerate_http_failed = !0, st(), lt()
                            }))) : ct(r, s) : ut(s) || ct(r, s)
                        }
                    }(t)
                } catch (e) {}
                Object.assign(Jt, e), er = !0
            },
            rr = function(e, t) {
                var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "";
        ...
        function sr(e, t) {
            ...
            if (!r) {
                if (Array.isArray(e) || (r = cr(e)) || t && e && "number" == typeof e.length) {
                    r && (e = r);
                    var n = 0,
                        i = function() {};
                    return {
        ...
        function dr(e) {
            return function() {
                ...
                return new Promise((function(n, i) {
                    ...
                    function s(e) {
                        lr(o, n, i, a, s, "throw", e)
                    }
                    a(void 0)
                }))
            }
        }
        var fr = Se().hybrid.isHybrid,
            pr = function() {
                var e = dr(regeneratorRuntime.mark((function e(t, r) {
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return e.abrupt("return", Kt.fetch(t, r));
                            case 1:
                            case "end":
                                return e.stop()
                        }
        ...
        pr = pr.bind(window);
        var hr, gr = fr ? pr : window.fetch,
            wr = function() {
                var e = dr(regeneratorRuntime.mark((function e(t) {
                    var r, n;
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
            ...
            br = function(e) {
                var t, r, n = Jt.baseUrl,
                    i = Jt.accelerate,
                    o = i.checkAccelerable,
                    a = i.enbleSites;
                return "string" == typeof(t = window._ACCELERATE_ORIGIN || i.defaultOrigin) && (t = (r = t) ? /^https?:/.test(r) ? r : "https://".concat(r) : r), a && Array.isArray(a) && !~a.indexOf(window.location.hostname) && (t = ""), /^(https?:)?\/\//.test(e) ? e : !fr && t && "string" == typeof t && /^(https?:)?\/\//.test(t) && o && o(e) ? "".concat(t).concat(e) : n ? "".concat(n).concat(e) : fr ? "".concat(window.location.origin).concat(e) : "".concat(e)
            },
            vr = {},
            mr = function() {
                var e = dr(regeneratorRuntime.mark((function e(t, r, n) {
                    var i, o, a, s, c, u, l, d, f, p, h, g, w, b, v, m, y, x, _, T, S, E, O, A, k, C, B, P;
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                o = Jt.requestInterceptors, a = Jt.responseInterceptors, s = Jt.resultInterceptors, c = Date.now(), u = (r || {}).body, l = rr((null === (i = r) || void 0 === i ? void 0 : i.method) || "GET", t, u), e.prev = 4, t = br(t), h = sr(o), e.prev = 7, h.s();
                            case 9:
                                if ((g = h.n()).done) {
                                    e.next = 20;
                                    break
                            ...
                            case 28:
                                return m = fr ? pr : window.fetch, e.next = 31, m(t, r, !0);
                            case 31:
                                d = e.sent, y = sr(a), e.prev = 33, y.s();
                            case 35:
                                if ((x = y.n()).done) {
                                    e.next = 42;
                                    break
                            ...
                            case 50:
                                return T = Date.now(), f = T - c, e.next = 54, wr(d);
                            case 54:
                                (E = d._bodyBlob) && (S = E.type);
                                try {
                                    (k = null === (O = d) || void 0 === O || null === (A = O.headers) || void 0 === A ? void 0 : A.get("content-type")) && (S = k)
                                } catch (e) {}
                            ...
                            case 84:
                                throw e.prev = 84, e.t3 = e.catch(4), vr[l] && (delete vr[l], console.warn("prefetch ".concat(l, " error"))), !fr && e.t3 && "TypeError" === e.t3.name && at(), fr || Ke({
                                    opts: r,
                                    url: t,
                                    res: d,
                                    duration: f,
                    ...
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                ...
                                return i = vr[n], delete vr[n], e.abrupt("return", i);
                            case 5:
                                return r = r || {}, o = Pe(), e.next = 9, ze(o, We(r));
                            case 9:
                                return a = e.sent, s = a.opts, e.abrupt("return", mr(t, s, r));
                            case 12:
                            case "end":
                                return e.stop()
                        }
            ...
            xr = function() {
                var e = dr(regeneratorRuntime.mark((function e(t, r) {
                    ...
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                if (n = u.length > 2 && void 0 !== u[2] ? u[2] : {}, i = rr("POST", t, JSON.stringify(nr(r))), !vr[i]) {
                                    e.next = 6;
                                    break
                                }
                                return o = vr[i], delete vr[i], e.abrupt("return", o);
                            case 6:
                                return a = Pe(), e.next = 9, ze(a, We(n));
                            case 9:
                                return s = e.sent, c = s.opts, c = Object.assign(c, {
                                    method: "POST",
                                    body: JSON.stringify(r)
                                }), e.abrupt("return", mr(t, c, n));
                            case 13:
                            case "end":
                                return e.stop()
                        }
            ...
            _r = function() {
                var e = dr(regeneratorRuntime.mark((function e(t, r) {
                    ...
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return n = s.length > 2 && void 0 !== s[2] ? s[2] : {}, i = Pe(), e.next = 4, ze(i, We(n));
                            case 4:
                                return o = e.sent, a = o.opts, a = Object.assign(a, {
                                    method: "PUT",
                                    body: JSON.stringify(r)
                                }), e.abrupt("return", mr(t, a, n));
                            case 8:
                            case "end":
                                return e.stop()
                        }
                    ...
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 4:
                                ...
                                return e.abrupt("return");
                            case 7:
                                return s = rr(o, t, "GET" === o ? "" : JSON.stringify(nr(a))), vr[s] = "GET" === o ? yr(t, r) : xr(t, a, r), e.abrupt("return", vr[s]);
                            case 10:
                            case "end":
                                return e.stop()
                        }
        ...
        }(hr = window._bn_http_init) && hr[0] ? Or(hr[0]) : (window._bn_http_init = window._bn_http_init || [], window._bn_http_init.push = function(e) {
            return Or(e)
        });
        var Rr = function() {
            ...
            Dr = function() {
                var e = Pr(regeneratorRuntime.mark((function e(t, r, n) {
                    var i, o, a, s, c, u, l, d, f, p, h, g, w;
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return o = n.options || {}, a = Mr(o.headers), n.onlyFile ? i = t : ((i = new FormData).append(n.name, t), r && Object.entries(r).map((function(e) {
                                    return i.append(e[0], e[1])
                                }))), e.next = 5, Ir(n.action, kr(kr({}, o), {}, {
                                    method: Rr(n.method),
                                    headers: a,
                                    body: i
                                }));
                            case 5:
                                ...
                                return c = s.body.getReader(), u = +(s.headers.get("Content-Length") || 0), l = 0, d = [], f = function() {
                                    var e = Pr(regeneratorRuntime.mark((function e() {
                                        var t;
                                        return regeneratorRuntime.wrap((function(e) {
                                            for (;;) switch (e.prev = e.next) {
                                                case 0:
        ...
        var Vr = {
            ...
            Hr = function() {
                var e = Gr(regeneratorRuntime.mark((function e(t, r) {
                    var n;
                    return regeneratorRuntime.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                if (r = Lr(Lr({}, Vr), r), e.prev = 1, r.fileSelected && r.fileSelected(t), n = function() {
                                        var e = Gr(regeneratorRuntime.mark((function e() {
                                            var n, i, o;
                                            return regeneratorRuntime.wrap((function(e) {
                                                for (;;) switch (e.prev = e.next) {
                                                    case 0:
                                                        if (e.prev = 0, n = Lr({}, r), !r.beforeUpload) {
                                                            e.next = 7;
                                                            break
                                                        }
                                                    ...
                                                    case 7:
                                                        return e.next = 9, Dr(n.file || t, n.data, n);
                                                    case 9:
        ...
        var qr = Ge,
            Xr = function() {
                return gr.apply(s, arguments)
            },
            Kr = function() {
                return yr.apply(s, arguments)
            },
            Zr = function() {
            ...
            Qr = function() {
                return Je.apply(s, arguments)
            },
            en = !1,
            tn = function() {
                en && console.error("[http] initConfig should only be called once."), en = !0;
                for (var e = arguments.length, t = new Array(e), r = 0; r < e; r++) t[r] = arguments[r];
                var n = (null == t ? void 0 : t[0]) || {},
                    i = n.requestInterceptor,
                    o = n.responseInterceptor,
                    a = n.resultInterceptor;
                return i && $t(i), o && Yt(o), a && Qt(a), {}
            },
            rn = function() {},
            nn = void 0,
            on = function() {},
            ...
            pn = dn("The string to be encoded contains characters out of range"),
            hn = "undefined" != typeof btoa ? function(e) {
                return btoa(e)
            } : function(e) {
                for (var t, r, n = String(e), i = "", o = 0, a = fn; n.charAt(0 | o) || (a = "=", o % 1); i += a.charAt(63 & t >> 8 - o % 1 * 8)) {
                    if ((r = n.charCodeAt(o += 3 / 4)) > 255) throw new pn;
                    t = t << 8 | r
                }
                return i
            };
        const gn = function(e) {
            ...
            wn = function(e) {
                return gn(e).replace(/\+/g, "-").replace(/\//g, "_")
            };
        var bn = dn("The string to be decoded is not correctly encoded"),
            vn = "undefined" != typeof atob ? function(e) {
                return atob(e)
            } : function(e) {
                var t = String(e).replace(/[=]+$/, "");
                if (t.length % 4 == 1) throw new bn;
                for (var r, n, i = "", o = 0, a = 0; n = t.charAt(a++); ~n && (r = o % 4 ? 64 * r + n : n, o++ % 4) ? i += String.fromCharCode(255 & r >> (-2 * o & 6)) : 0) n = fn.indexOf(n);
                return i
            };
        const mn = function(e) {
                return function(e) {
            ...
            yn = function(e) {
                return mn(e.replace(/-/g, "+").replace(/_/g, "/"))
            };
        var xn = ".";
        ...
        function _n() {
            ...
            return r.length > 2 ? r.slice(-t).join(xn) : e
        }
        window.uuid = i, window.b2aSDK = u, window.MD5 = Y();
        var Tn = /^\/([^/]*)/;
        ...
        function On(e) {
            var t;
            Be("lang", e, 365, !0, "High"), Be(En, e, 180, !1);
            var r = new URL(window.location.href);
            (null === (t = r.pathname.match(Tn)) || void 0 === t ? void 0 : t[1]) === Sn().replace(/\//g, "") && (r.pathname = r.pathname.replace(Tn, "")), r.searchParams.delete("hl"), window.location.href = r.href
        }
        var An = {
                a: {
                    a: {
        ...
        var Bn = ["utm_content", "utm_medium", "utm_source", "utm_campaign"],
            Pn = {
                utm_content: "bu_c",
                utm_medium: "bu_m",
                utm_source: "bu_s",
        ...
        function In() {
            var e = {};
            try {
                if (e = Mn(), Object.keys(e).length > 0) return Nn(), e;
        ...
        function Nn() {
            try {
                var e = Mn();
                Object.keys(e).length > 0 && Bn.forEach((function(t) {
                    var r = e[t];
                    r ? Rn.write(t, r) : Rn.erase(t)
                }))
            } catch (e) {
        ...
        window.httpSDK || (window.httpSDK = c), window.regeneratorRuntime = p
    })(), n
})()));