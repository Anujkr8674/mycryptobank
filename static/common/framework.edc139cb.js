...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "f7736f66-dfbf-5388-9b94-5a4ff4f6e834")
    } catch (e) {}
}();
        ...
        wcIl: (t, e, n) => {
            ...
            class H {
                constructor({
                    ...
                    this.action = L, this.location = A("/"), this.doTransition = () => {}, this._index = 0, this._blockers = d(), this.basename = w(t)
                }
                back() {
                    this.go(-1)
                }
        ...
        "2rPy": (t, e, n) => {
            ...
            function D() {
                ...
                c.useEffect((function() {
                    k.t.traceChild(T.name).stop(), t.beforeEach((function(t, e, r) {
                        var o, s = "".concat(e.pathname).concat(e.search),
                            ...
                            c = (o = {}, (0, A.A)(o, R.attrs.from.name, s), (0, A.A)(o, R.attrs.to.name, i), (0, A.A)(o, R.attrs.navigationId.name, a), o);
                        k.t.traceChild(I.name, c).stop(), n.current = k.t.traceChild(R.name), n.current.setAttributes(c), r()
                    }))
                }), []), c.useEffect((function() {
                    var t;
            ...
            V = function(t, e) {
                var n = t.root,
                    r = t.appContainer;
                t.shouldHydrate ? (F = K(r, n), null === e || void 0 === e || e()) : (F || (F = z(r)), F.render(n))
            };
            ...
            const J = new function t() {
                ...
                (0, f.A)(this, t), this._isInitialRender = !0, this.renderApp = function(t) {
                    return Y(e, [t], void 0, s().mark((function t(e) {
                        ...
                        return s().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                ...
                                case 17:
                                    ...
                                    }), k.x.traceChild(p.ft.events.SHUVI_CLIENT_DO_RENDER.name).traceFn((function() {
                                        V({
                                            root: v,
                                            appContainer: n,
                                            shouldHydrate: _
            ...
            var Dt, Nt = function(t, e, n, o) {
                                ...
                                getLoaders: function() {
                                    return At(e, void 0, void 0, s().mark((function t() {
                                        ...
                                        return s().wrap((function(t) {
                                            for (;;) switch (t.prev = t.next) {
                                                case 0:
                                                    return t.next = 2, Promise.all([n.e(596), n.e(625)]).then(n.bind(n, "zE6/"));
                                                case 2:
                        ...
                        return Nt(void 0, void 0, void 0, s().mark((function r() {
                            ...
                            return s().wrap((function(r) {
                                for (;;) switch (r.prev = r.next) {
                                    ...
                                    case 8:
                                        return o = k.t.traceChild(Lt.name), r.next = 11, Dt.getLoaders();
                                    case 11:
                                    ...
                                    case 23:
                                        ...
                                        return h = r.t0.headers.get("Location"), Tt(h) ? window.location.replace(h) : n(h), o.setAttribute(Lt.attrs.errorType.name, "redirect"), o.stop(), r.abrupt("return");
                                    case 32:
                ...
                $t = (0, X.Y)(),
                Ut = k.x.traceChild(p.ft.events.SHUVI_CLIENT_CREATE_APP.name).traceFn((function() {
                    return Mt({
                        appComponent: h,
                        routes: Z.A,
                        appData: $t
            ...
            window.__SHUVI ? window.__SHUVI.router = Ut.router : window.__SHUVI = {
                ...
                return s().wrap((function(t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                            return e = k.x.traceChild(p.ft.events.SHUVI_CLIENT_RUN_APP.name), t.next = 3, k.x.traceChild(p.ft.events.SHUVI_CLIENT_APP_INIT.name).traceAsyncFn((function() {
                                return Ut.init()
                            }));
                        case 3:
        ...
        VyXn: (t, e, n) => {
            ...
            function St() {
                const t = this.__r_state,
                    ...
                    n = 0 !== e.size,
                    r = e.clear();
                return n && (_t(t), R(t), t.copy.clear(), nt(t, "clear", void 0, void 0)), r
            }
...
//# debugId=f7736f66-dfbf-5388-9b94-5a4ff4f6e834