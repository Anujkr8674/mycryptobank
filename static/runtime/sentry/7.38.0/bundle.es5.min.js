...
var Sentry = function(t) {
    ...
    function j(t, n) {
        void 0 === n && (n = {});
        try {
            for (var r = t, e = [], i = 0, o = 0, u = " > ".length, a = void 0, f = Array.isArray(n) ? n : n.keyAttrs, c = !Array.isArray(n) && n.maxStringLength || 80; r && i++ < 5 && !("html" === (a = k(r, f)) || i > 1 && o + e.length * u + a.length >= c);) e.push(a), o += a.length, r = r.parentNode;
    ...
    function k(t, n) {
        ...
        else if (a.id && f.push("#" + a.id), (r = a.className) && h(r))
            for (e = r.split(/\s+/), u = 0; u < e.length; u++) f.push("." + e[u]);
        var s = ["aria-label", "type", "name", "title", "alt"];
        for (u = 0; u < s.length; u++) i = s[u], (o = a.getAttribute(i)) && f.push("[" + i + '="' + o + '"]');
        return f.join("")
    }
    var S = function(t) {
            function n(n, r) {
                ...
                return i.message = n, i.name = e.prototype.constructor.name, Object.setPrototypeOf(i, e.prototype), i.logLevel = r, i
            }
            return r(n, t), n
        }(Error),
        x = /^(?:(\w+):)\/\/(?:(\w+)(?::(\w+)?)?@)([\w.-]+)(?::(\d+))?\/(.+)/;
    ...
    function T(t) {
        return "string" == typeof t ? function(t) {
            var n = x.exec(t);
            if (!n) throw new S("Invalid Sentry Dsn: " + t);
            var r = o(n.slice(1), 6),
                e = r[0],
                i = r[1],
                u = r[2],
                ...
                h = r[5],
                l = h.split("/");
            if (l.length > 1 && (v = l.slice(0, -1).join("/"), h = l.pop()), h) {
                var d = h.match(/^\d+/);
                d && (h = d[0])
            }
            return R({
    ...
    function A(t, n) {
        return void 0 === n && (n = 0), "string" != typeof t || 0 === n || t.length <= n ? t : t.slice(0, n) + "..."
    }
    ...
    function M(t, n, r) {
        return void 0 === r && (r = !1), !!h(t) && (c(n, "RegExp") ? n.test(t) : !!h(n) && (r ? t === n : t.includes(n)))
    }

    function L(t, n, r) {
        return void 0 === n && (n = []), void 0 === r && (r = !1), n.some((function(n) {
            return M(t, n, r)
        }))
    }
    ...
    function U(t, n) {
        var r = n.prototype || {};
        t.prototype = n.prototype = r, q(t, "__sentry_original__", n)
    }
    ...
    function P(t) {
        ...
        if (y(t)) {
            ...
            return "undefined" != typeof CustomEvent && m(t, CustomEvent) && (n.detail = t.detail), n
        }
        return t
    }
    ...
    function X(t) {
        try {
            return n = t, "undefined" != typeof Element && m(n, Element) ? j(t) : Object.prototype.toString.call(t)
        } catch (t) {
            return "<unknown>"
        }
        var n
    ...
    function F(t, n) {
        ...
        if (r[0].length >= n) return A(r[0], n);
        for (var e = r.length; e > 0; e--) {
            var i = r.slice(0, e).join(", ");
            if (!(i.length > n)) return e === r.length ? i : A(i, n)
        }
        return ""
    }
    ...
    function B(t, n) {
        ...
        if (Array.isArray(t)) {
            ...
            if (void 0 !== (c = n.get(t))) return c;
            var s = [];
            return n.set(t, s), t.forEach((function(t) {
                s.push(B(t, n))
            })), s
        }
        return t
            ...
            try {
                for (var d = i(t.split("\n").slice(n)), y = d.next(); !y.done; y = d.next()) {
                    ...
                    if (!(p.length > 1024)) {
                        ...
                        try {
                            for (var b = (f = void 0, i(r)), w = b.next(); !w.done; w = b.next()) {
                                var E, _ = (E = w.value)(m);
                                if (_) {
                                    var j = J.get(E);
                                    if (j && _.filename) {
        ...
        if (!et[t]) switch (et[t] = !0, t) {
            ...
            case "dom":
                ! function() {
                    ...
                    var t = ut.bind(null, "dom"),
                        n = vt(t, !0);
                    nt.document.addEventListener("click", n, !1), nt.document.addEventListener("keypress", n, !1), ["EventTarget", "Node"].forEach((function(n) {
                            ...
                            return function(n, r, e) {
                                if ("click" === n || "keypress" == n) try {
                                    var i = this,
                                        ...
                                        u = o[n];
                                    u && (u.refCount--, u.refCount <= 0 && (t.call(this, n, u.handler, e), u.handler = void 0, delete o[n]), 0 === Object.keys(o).length && delete i.__sentry_instrumentation_handlers__)
                                } catch (t) {}
                ...
                ! function() {
                    ...
                    C(t, "open", (function(t) {
                        return function() {
                            ...
                            })) : e.addEventListener("readystatechange", u), t.apply(e, n)
                        }
                    })), C(t, "send", (function(t) {
                        return function() {
                            for (var n = [], r = 0; r < arguments.length; r++) n[r] = arguments[r];
                            return this.__sentry_xhr__ && void 0 !== n[0] && (this.__sentry_xhr__.body = n[0]), ut("xhr", {
                                args: n,
                                startTimestamp: Date.now(),
                                xhr: this
                            }), t.apply(this, n)
            ...
            case "fetch":
                ! function() {
                    if (! function() {
                            if (!Q()) return !1;
                            if (Z(Y.fetch)) return !0;
                            var t = !1,
                                n = Y.document;
                            if (n && "function" == typeof n.createElement) try {
                                var r = n.createElement("iframe");
                                r.hidden = !0, n.head.appendChild(r), r.contentWindow && r.contentWindow.fetch && (t = Z(r.contentWindow.fetch)), n.head.removeChild(r)
                            } catch (t) {}
                            return t
                        }()) return;
                    C(nt, "fetch", (function(t) {
                        return function() {
                            ...
                            return ut("fetch", e({}, i)), t.apply(nt, n).then((function(t) {
            ...
            case "history":
                ! function() {
                    ...
                    }, C(nt.history, "pushState", n), C(nt.history, "replaceState", n)
                }();
                break;
            case "error":
                ht = nt.onerror, nt.onerror = function(t, n, r, e, i) {
                    return ut("error", {
                        column: e,
                        error: i,
                        line: r,
            ...
            case "unhandledrejection":
                dt = nt.onunhandledrejection, nt.onunhandledrejection = function(t) {
                    return ut("unhandledrejection", t), !dt || dt.apply(this, arguments)
                };
                break;
            default:
                return
    ...
    function at(t) {
        return void 0 === t && (t = []), "Request" in nt && m(t[0], Request) && t[0].method ? String(t[0].method).toUpperCase() : t[1] && t[1].method ? String(t[1].method).toUpperCase() : "GET"
    }

    function ft(t) {
        return void 0 === t && (t = []), "string" == typeof t[0] ? t[0] : "Request" in nt && m(t[0], Request) ? t[0].url : String(t[0])
    }
    var ct, st;
            ...
            function(r) {
                if (r && st !== r && ! function(t) {
                    ...
                    (void 0 === ct || function(t, n) {
                        ...
                        name: e,
                        global: n
                    }), st = r), clearTimeout(ct), ct = nt.setTimeout((function() {
                        ct = void 0
                    }), 1e3)
                }
            }
    ...
    function kt(t, n, r, e, i) {
        var u, a;
        void 0 === r && (r = 1 / 0), void 0 === e && (e = 1 / 0), void 0 === i && (u = "function" == typeof WeakSet, a = u ? new WeakSet : [], i = [function(t) {
            if (u) return !!a.has(t) || (a.add(t), !1);
        ...
        var f, c = o(i, 2),
            s = c[0],
            v = c[1];
        if (null === n || ["number", "boolean", "string"].includes(typeof n) && ("number" != typeof(f = n) || f == f)) return n;
        var h = function(t, n) {
            try {
    ...
    var Ot = function() {
        function t(t) {
            var n = this;
            this.o = lt.PENDING, this.u = [], this.v = function(t) {
                n.h(lt.RESOLVED, t)
            }, this.l = function(t) {
                n.h(lt.REJECTED, t)
            }, this.h = function(t, r) {
                n.o === lt.PENDING && (p(r) ? r.then(n.v, n.l) : (n.o = t, n.p = r, n.m()))
            }, this.m = function() {
                if (n.o !== lt.PENDING) {
                    var t = n.u.slice();
                    n.u = [], t.forEach((function(t) {
                        t[0] || (n.o === lt.RESOLVED && t[1](n.p), n.o === lt.REJECTED && t[2](n.p), t[0] = !0)
                    }))
                }
            };
            try {
    ...
    function Rt(t) {
        ...
        return {
            $: n,
            add: function(e) {
                if (!(void 0 === t || n.length < t)) return xt(new S("Not adding Promise because buffer limit was reached."));
                var i = e();
        ...
        try {
            for (var v = i(f), h = v.next(); !h.done; h = v.next()) {
                var l = o(h.value, 2),
                    d = l[0],
                    y = l[1];
                if (s("\n" + JSON.stringify(d) + "\n"), "string" == typeof y || y instanceof Uint8Array) s(y);
                else {
                    var p = void 0;
                    try {
                        p = JSON.stringify(y)
        ...
        if (l) try {
            for (var y = i(l.trim().split(",")), p = y.next(); !p.done; p = y.next()) {
                var m = o(p.value.split(":", 2), 2),
                    ...
                    E = 1e3 * (isNaN(w) ? 60 : w);
                if (g) try {
                    for (var _ = (f = void 0, i(g.split(";"))), j = _.next(); !j.done; j = _.next()) {
                        h[j.value] = r + E
                    }
                } catch (t) {
                    f = {
    ...
    function Gt(t, n) {
        if (void 0 === n && (n = {}), n.user && (!t.ipAddress && n.user.ip_address && (t.ipAddress = n.user.ip_address), t.did || n.did || (t.did = n.user.id || n.user.email || n.user.username)), t.timestamp = n.timestamp || Ct(), n.ignoreDuration && (t.ignoreDuration = n.ignoreDuration), n.sid && (t.sid = 32 === n.sid.length ? n.sid : yt()), void 0 !== n.init && (t.init = n.init), !t.did && n.did && (t.did = "" + n.did), "number" == typeof n.started && (t.started = n.started), t.ignoreDuration) t.duration = void 0;
    ...
    var Kt = function() {
        function t() {
            this.g = !1, this._ = [], this.j = [], this.k = [], this.S = [], this.O = {}, this.R = {}, this.T = {}, this.D = {}, this.N = {}
        }
        return t.clone = function(n) {
            var r = new t;
            return n && (r.k = u(n.k), r.R = e({}, n.R), r.T = e({}, n.T), r.D = e({}, n.D), r.O = n.O, r.A = n.A, r.I = n.I, r.M = n.M, r.L = n.L, r.C = n.C, r.j = u(n.j), r.q = n.q, r.S = u(n.S), r.N = e({}, n.N)), r
        }, t.prototype.addScopeListener = function(t) {
            this._.push(t)
        }, t.prototype.addEventProcessor = function(t) {
            return this.j.push(t), this
        }, t.prototype.setUser = function(t) {
            return this.O = t || {}, this.M && Gt(this.M, {
                user: t
            }), this.U(), this
            ...
            return this.R = e(e({}, this.R), t), this.U(), this
        }, t.prototype.setTag = function(t, n) {
            var r;
            return this.R = e(e({}, this.R), ((r = {})[t] = n, r)), this.U(), this
        }, t.prototype.setExtras = function(t) {
            return this.T = e(e({}, this.T), t), this.U(), this
        }, t.prototype.setExtra = function(t, n) {
            var r;
            return this.T = e(e({}, this.T), ((r = {})[t] = n, r)), this.U(), this
            ...
            return n instanceof t ? (this.R = e(e({}, this.R), n.R), this.T = e(e({}, this.T), n.T), this.D = e(e({}, this.D), n.D), n.O && Object.keys(n.O).length && (this.O = n.O), n.A && (this.A = n.A), n.C && (this.C = n.C), n.q && (this.q = n.q)) : d(n) && (n = n, this.R = e(e({}, this.R), n.tags), this.T = e(e({}, this.T), n.extra), this.D = e(e({}, this.D), n.contexts), n.user && (this.O = n.user), n.level && (this.A = n.level), n.fingerprint && (this.C = n.fingerprint), n.requestSession && (this.q = n.requestSession)), this
        }, t.prototype.clear = function() {
            return this.k = [], this.R = {}, this.T = {}, this.O = {}, this.D = {}, this.A = void 0, this.L = void 0, this.C = void 0, this.q = void 0, this.I = void 0, this.M = void 0, this.U(), this.S = [], this
            ...
            if (void 0 === n && (n = {}), this.T && Object.keys(this.T).length && (t.extra = e(e({}, this.T), t.extra)), this.R && Object.keys(this.R).length && (t.tags = e(e({}, this.R), t.tags)), this.O && Object.keys(this.O).length && (t.user = e(e({}, this.O), t.user)), this.D && Object.keys(this.D).length && (t.contexts = e(e({}, this.D), t.contexts)), this.A && (t.level = this.A), this.L && (t.transaction = this.L), this.I) {
                t.contexts = e({
            ...
            return this.H(t), t.breadcrumbs = u(t.breadcrumbs || [], this.k), t.breadcrumbs = t.breadcrumbs.length > 0 ? t.breadcrumbs : void 0, t.sdkProcessingMetadata = e(e({}, t.sdkProcessingMetadata), this.N), this.P(u(Vt(), this.j), t, n)
        }, t.prototype.setSDKProcessingMetadata = function(t) {
            return this.N = e(e({}, this.N), t), this
        }, t.prototype.P = function(t, n, r, i) {
            var o = this;
            return void 0 === i && (i = 0), new Ot((function(u, a) {
                var f = t[i];
                if (null === n || "function" != typeof f) u(n);
                else {
                    var c = f(e({}, n), r);
            ...
            var t = this;
            this.g || (this.g = !0, this._.forEach((function(n) {
                n(t)
            })), this.g = !1)
        }, t.prototype.H = function(t) {
            t.fingerprint = t.fingerprint ? Et(t.fingerprint) : [], this.C && (t.fingerprint = t.fingerprint.concat(this.C)), t.fingerprint && !t.fingerprint.length && delete t.fingerprint
        }, t
    }();
    ...
    var Qt = function() {
        function t(t, n, r) {
            void 0 === n && (n = new Kt), void 0 === r && (r = 4), this.X = r, this.F = [{}], this.getStackTop().scope = n, t && this.bindClient(t)
        }
        return t.prototype.isOlderThan = function(t) {
            ...
            return t.type || (this.W = r), this.B((function(i, o) {
    ...
    function nn() {
        var t, n = Zt();
        return (t = n) && t.__SENTRY__ && t.__SENTRY__.hub && !rn(n).isOlderThan(4) || en(n, new Qt), rn(n)
    }
    ...
    function cn(t, n, r, i) {
        ...
        ! function(t, n) {
            n && (t.sdk = t.sdk || {}, t.sdk.name = t.sdk.name || n.name, t.sdk.version = t.sdk.version || n.version, t.sdk.integrations = u(t.sdk.integrations || [], n.integrations || []), t.sdk.packages = u(t.sdk.packages || [], n.packages || []))
        }(t, r && r.sdk);
        ...
        return delete t.sdkProcessingMetadata, qt(f, [
            [{
                type: a
            }, t]
        ])
    ...
    function hn(t, n) {
        n[t.name] = t, -1 === sn.indexOf(t.name) && (t.setupOnce(Yt, nn), sn.push(t.name))
    }
    ...
    function ln(t, n, r, i) {
        ...
        function(t, n) {
            n.length > 0 && (t.sdk = t.sdk || {}, t.sdk.integrations = u(t.sdk.integrations || [], n))
        }(s, v);
        var h = i;
        ...
        return l.then((function(t) {
            return "number" == typeof a && a > 0 ? function(t, n, r) {
                ...
                t.contexts && t.contexts.trace && i.contexts && (i.contexts.trace = t.contexts.trace, t.contexts.trace.data && (i.contexts.trace.data = _t(t.contexts.trace.data, n, r)));
                t.spans && (i.spans = t.spans.map((function(t) {
                    return t.data && (t.data = _t(t.data, n, r)), t
                })));
                return i
            }(t, a, c) : t
        }))
    ...
    var dn = function() {
        function t(t) {
            if (this._integrations = {}, this.V = !1, this.Y = 0, this.Z = {}, this.tt = t, t.dsn) {
                this.nt = T(t.dsn);
                var n = fn(this.nt, t);
        ...
        return t.prototype.captureException = function(t, n, r) {
            ...
            this._isEnabled() && ("string" != typeof t.release || (this.sendSession(t), Gt(t, {
                init: !1
            })))
            ...
            var t, n;
            this._isEnabled() && !this.V && (this._integrations = (t = this.tt.integrations, n = {}, t.forEach((function(t) {
                t && hn(t, n)
            })), n), this.V = !0)
            ...
            return new Ot((function(r) {
                var e = 0,
                    i = setInterval((function() {
                        0 == n.Y ? (clearInterval(i), r(!0)) : (e += 1, t && e >= t && (clearInterval(i), r(!1)))
                    }), 1)
            }))
            ...
            return !n.integrations && i.length > 0 && (n.integrations = i), ln(e, t, n, r)
        }, t.prototype.it = function(t, n, r) {
            return void 0 === n && (n = {}), this.st(t, n, r).then((function(t) {
                return t.event_id
            }), (function(t) {}))
            ...
            var i = this,
                o = this.getOptions(),
                u = o.sampleRate;
            if (!this._isEnabled()) return xt(new S("SDK not enabled, will not capture event.", "log"));
            var a = pn(t),
                f = yn(t),
                c = t.type || "error",
                s = "before send for type `" + c + "`";
            if (f && "number" == typeof u && Math.random() > u) return this.recordDroppedEvent("sample_rate", "error", t), xt(new S("Discarding event because it's not included in the random sample (sampling rate = " + u + ")", "log"));
            var v = "replay_event" === c ? "replay" : c;
            return this.ct(t, n, r).then((function(r) {
                if (null === r) throw i.recordDroppedEvent("event_processor", v, t), new S("An event processor returned `null`, will not send event.", "log");
                if (n.data && !0 === n.data.__sentry__) return r;
                var e = function(t, n, r) {
                    var e = t.beforeSend,
                        i = t.beforeSendTransaction;
                    if (yn(n) && e) return e(n, r);
                    if (pn(n) && i) return i(n, r);
                    return n
                }(o, r, n);
                return function(t, n) {
                    var r = n + " must return `null` or a valid event.";
                    if (p(t)) return t.then((function(t) {
                        if (!d(t) && null !== t) throw new S(r);
                        return t
                    }), (function(t) {
                ...
                if (null === o) throw i.recordDroppedEvent("before_send", v, t), new S(s + " returned `null`, will not send event.", "log");
            ...
            var t = this.Z;
            return this.Z = {}, Object.keys(t).map((function(n) {
                var r = o(n.split(":"), 2);
                return {
                    reason: r[0],
                    category: r[1],
        ...
        return {
            send: function(i) {
                ...
                if (Ht(i, (function(n, r) {
                        var i, u, a, f = Wt(r);
                        if (i = e, u = f, void 0 === a && (a = Date.now()), function(t, n) {
                                return t[n] || t.all || 0
                            }(i, u) > a) {
                            var c = bn(n, r);
                            t.recordDroppedEvent("ratelimit_backoff", f, c)
                        } else o.push(n)
                    })), 0 === o.length) return St();
                var u = qt(i[0], o),
                    a = function(n) {
                        Ht(u, (function(r, e) {
                            var i = bn(r, e);
                ...
                return r.add((function() {
                    ...
                    if (t instanceof S) return a("queue_overflow"), St();
                    throw t
                }))
            },
            flush: function(t) {
    ...
    var gn, wn = "7.38.0",
        En = function() {
            ...
            return t.prototype.setupOnce = function() {
                gn = Function.prototype.toString, Function.prototype.toString = function() {
                    for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
                    var r = H(this) || this;
                    return gn.apply(r, t)
                }
        ...
        _n = [/^Script error\.?$/, /^Javascript error: Script error\.? on line 0$/],
        jn = function() {
            function t(n) {
                void 0 === n && (n = {}), this.tt = n, this.name = t.id
            }
    ...
    function Dn(t, n, r) {
        ...
        var sentryWrapped = function() {
            ...
            try {
                ...
                throw Tn(), on((function(r) {
                    r.addEventProcessor((function(t) {
                        return n.mechanism && (bt(t, void 0, void 0), gt(t, n.mechanism)), t.extra = e(e({}, t.extra), {
                            arguments: i
                        }), t
                    })), captureException(t)
                })), t
        ...
        U(sentryWrapped, t), q(t, "__sentry_wrapped__", sentryWrapped);
        try {
    ...
    function Cn(t, n, r, e) {
        ...
        return gt(i), i.level = "error", r && r.event_id && (i.event_id = r.event_id), St(i)
    }

    function qn(t, n, r, e, i) {
        void 0 === r && (r = "info");
        var o = Hn(t, n, e && e.syntheticException || void 0, i);
        return o.level = r, e && e.event_id && (o.event_id = e.event_id), St(o)
    }

    function Un(t, n, r, i, o) {
        var u;
        if (s(n) && n.error) return An(t, n.error);
        if (v(n) || c(n, "DOMException")) {
            var a = n;
            if ("stack" in n) u = An(t, n);
            else {
        ...
        return f(n) ? An(t, n) : d(n) || y(n) ? (u = function(t, n, r, e) {
            ...
            synthetic: !0
        }), u) : (bt(u = Hn(t, n, r, i), "" + n, void 0), gt(u, {
            synthetic: !0
        }), u)
    }
    ...
    var Pn = 1024,
        ...
        $n = function() {
            ...
            return t.prototype.setupOnce = function() {
                this.options.console && ot("console", Fn), this.options.dom && ot("dom", function(t) {
                    function n(n) {
                        ...
                        i && i > Pn && (i = Pn), "string" == typeof e && (e = [e]);
                        try {
                    ...
                    return n
                }(this.options.dom)), this.options.xhr && ot("xhr", Wn), this.options.fetch && ot("fetch", Bn), this.options.history && ot("history", Jn)
    ...
    function Fn(t) {
        ...
        var r, e = {
            ...
            level: (r = t.level, "warn" === r ? "warning" : Dt.includes(r) ? r : "log"),
            message: I(t.args, " ")
        };
        if ("assert" === t.level) {
            if (!1 !== t.args[0]) return;
            e.message = "Assertion failed: " + (I(t.args.slice(1), " ") || "console.assert"), e.data.arguments = t.args.slice(1)
        }
        nn().addBreadcrumb(e, {
            input: t.args,
            level: t.level
    ...
    function Jn(t) {
        var n = t.from,
            ...
            i = Tt(n),
            o = Tt(r);
        i.path || (i = e), e.protocol === o.protocol && e.host === o.host && (r = o.relative), e.protocol === i.protocol && e.host === i.host && (n = i.relative), nn().addBreadcrumb({
            category: "navigation",
            data: {
                from: n,
                to: r
    ...
    var zn = function(t) {
            function n(n) {
                ...
                return n.K = n.K || {}, n.K.sdk = n.K.sdk || {
                    ...
                    version: wn
                }, r = t.call(this, n) || this, n.sendClientReports && xn.document && xn.document.addEventListener("visibilitychange", (function() {
            ...
            return r(n, t), n.prototype.eventFromException = function(t, n) {
                ...
                return void 0 === n && (n = "info"), qn(this.tt.stackParser, t, n, r, this.tt.attachStacktrace)
            }, n.prototype.sendEvent = function(n, r) {
                var e = this.getIntegrationById(Xn);
                e && e.addSentryBreadcrumb && e.addSentryBreadcrumb(n), t.prototype.sendEvent.call(this, n, r)
            }, n.prototype.ct = function(n, r, e) {
                return n.platform = n.platform || "javascript", t.prototype.ct.call(this, n, r, e)
            }, n.prototype.ht = function() {
                var t = this.vt();
                if (0 !== t.length && this.nt) {
                    var n, r, e, i = fn(this.nt, this.tt),
                        o = (n = t, qt((r = this.tt.tunnel && O(this.nt)) ? {
                            dsn: r
                        } : {}, [
                            [{
                                type: "client_report"
                    ...
                    try {
                        if ("[object Navigator]" === Object.prototype.toString.call(xn && xn.navigator) && "function" == typeof xn.navigator.sendBeacon && !this.tt.transportOptions) xn.navigator.sendBeacon.bind(xn.navigator)(i, Xt(o));
                        else this.ut(o)
                    } catch (t) {}
                }
            }, n
    ...
    function Kn(t, n) {
        return void 0 === n && (n = function() {
            if (Gn) return Gn;
            if (Z(xn.fetch)) return Gn = xn.fetch.bind(xn);
            var t = xn.document,
                n = xn.fetch;
    ...
    function Vn(t) {
        return mn(t, (function(n) {
            return new Ot((function(r, e) {
                ...
                for (var o in i.onerror = e, i.onreadystatechange = function() {
                        4 === i.readyState && r({
                            statusCode: i.status,
                            headers: {
    ...
    var Zn = /^\s*at (?:(.*\).*?|.*?) ?\((?:address at )?)?(?:async )?((?:file|https?|blob|chrome-extension|address|native|eval|webpack|<anonymous>|[-a-z]+:|.*bundle|\/)?.*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i,
        ...
        ir = [50, function(t) {
            ...
            if (r) {
                ...
                var i = r[3],
                    u = r[1] || Yn;
                return u = (n = o(lr(u, i), 2))[0], Qn(i = n[1], u, r[4] ? +r[4] : void 0, r[5] ? +r[5] : void 0)
            }
        }],
        ...
        ot("error", (function(t) {
            ...
            if (r.getIntegration(dr)) {
                ...
                if (!(Rn() || v && v.__sentry_own_request__)) {
                    ...
                    l.level = "error", br(r, v, l, "onerror")
                }
            }
        }))
    }
    ...
    function pr() {
        ot("unhandledrejection", (function(t) {
            ...
            if (r.getIntegration(dr)) {
                ...
                if (Rn() || u && u.__sentry_own_request__) return !0;
                var a = l(u) ? {
                    exception: {
                        values: [{
                ...
                a.level = "error", br(r, u, a, "onunhandledrejection")
            }
        }))
    }
    ...
    var wr = ["EventTarget", "Window", "Node", "ApplicationCache", "AudioTrackList", "ChannelMergerNode", "CryptoOperation", "EventSource", "FileReader", "HTMLUnknownElement", "IDBDatabase", "IDBRequest", "IDBTransaction", "KeyOperation", "MediaController", "MessagePort", "ModalWindow", "Notification", "SVGElementInstance", "Screen", "TextTrack", "TextTrackCue", "TextTrackList", "WebSocket", "WebSocketWorker", "Worker", "XMLHttpRequest", "XMLHttpRequestEventTarget", "XMLHttpRequestUpload"],
        Er = function() {
            ...
            return t.prototype.setupOnce = function() {
                this.tt.setTimeout && C(xn, "setTimeout", _r), this.tt.setInterval && C(xn, "setInterval", _r), this.tt.requestAnimationFrame && C(xn, "requestAnimationFrame", jr), this.tt.XMLHttpRequest && "XMLHttpRequest" in xn && C(XMLHttpRequest.prototype, "send", kr);
            ...
            return i.forEach((function(t) {
                t in e && "function" == typeof e[t] && C(e, t, (function(n) {
                    var r = {
                        ...
                        e = H(n);
                    return e && (r.mechanism.data.handler = V(e)), Dn(n, r)
                }))
            })), t.apply(this, n)
        }
    }
    ...
    var xr = function() {
        function t(n) {
            void 0 === n && (n = {}), this.name = t.id, this.dt = n.key || "cause", this.yt = n.limit || 5
        }
        return t.prototype.setupOnce = function() {
            var n = nn().getClient();
            n && Yt((function(r, e) {
                ...
                return i ? function(t, n, r, e, i) {
                    if (!(e.exception && e.exception.values && i && m(i.originalException, Error))) return e;
                    var o = Or(t, r, i.originalException, n);
                    return e.exception.values = u(o, e.exception.values), e
    ...
    function Or(t, n, r, e, i) {
        if (void 0 === i && (i = []), !m(r[e], Error) || i.length + 1 >= n) return i;
        var o = Nn(t, r[e]);
            ...
            return t.prototype.setupOnce = function() {
                Yt((function(n) {
                    if (nn().getIntegration(t)) {
                        if (!xn.navigator && !xn.location && !xn.document) return n;
    ...
    return t.Breadcrumbs = $n, t.BrowserClient = zn, t.Dedupe = Tr, t.FunctionToString = En, t.GlobalHandlers = dr, t.HttpContext = Rr, t.Hub = Qt, t.InboundFilters = jn, t.Integrations = Ur, t.LinkedErrors = xr, t.SDK_VERSION = wn, t.Scope = Kt, t.TryCatch = Er, t.WINDOW = xn, t.addBreadcrumb = function(t) {
        nn().addBreadcrumb(t)
    }, t.addGlobalEventProcessor = Yt, t.captureEvent = function(t, n) {
    ...
    }, t.chromeStackLineParser = nr, t.close = function(t) {
        var n = nn().getClient();
        return n ? n.close(t) : St(!1)
    }, t.configureScope = function(t) {
        nn().configureScope(t)
    }, t.createTransport = mn, t.defaultIntegrations = Lr, t.defaultStackLineParsers = vr, t.defaultStackParser = hr, t.eventFromException = Cn, t.eventFromMessage = qn, t.flush = function(t) {
        var n = nn().getClient();
        return n ? n.flush(t) : St(!1)
    }, t.forceLoad = function() {}, t.geckoStackLineParser = ir, t.getCurrentHub = nn, t.getHubFromCarrier = rn, t.init = function(t) {
        void 0 === t && (t = {}), void 0 === t.defaultIntegrations && (t.defaultIntegrations = Lr), void 0 === t.release && ("string" == typeof __SENTRY_RELEASE__ && (t.release = __SENTRY_RELEASE__), xn.SENTRY_RELEASE && xn.SENTRY_RELEASE.id && (t.release = xn.SENTRY_RELEASE.id)), void 0 === t.autoSessionTracking && (t.autoSessionTracking = !0), void 0 === t.sendClientReports && (t.sendClientReports = !0);
        var n, r = e(e({}, t), {
            stackParser: (n = t.stackParser || hr, Array.isArray(n) ? z.apply(void 0, u(n)) : n),
            integrations: vn(t),
        ...
        ! function(t, n) {
            ...
            var i = new t(n);
            r.bindClient(i)
        }(zn, r), t.autoSessionTracking && function() {
            if (void 0 === xn.document) return;
            var t = nn();
            if (!t.captureSession) return;
            Cr(t), ot("history", (function(t) {
                var n = t.from,
                    r = t.to;
                void 0 !== n && n !== r && Cr(nn())
            }))
    ...
    }, t.makeFetchTransport = Kn, t.makeMain = tn, t.makeXHRTransport = Vn, t.onLoad = function(t) {
        t()
    }, t.opera10StackLineParser = fr, t.opera11StackLineParser = sr, t.setContext = function(t, n) {
        nn().setContext(t, n)
        ...
        if (void 0 === t && (t = {}), void 0 === n && (n = nn()), xn.document) {
            var r = n.getStackTop(),
                i = r.client,
                o = r.scope,
                u = t.dsn || i && i.getDsn();
            if (u) {
                o && (t.user = e(e({}, o.getUser()), t.user)), t.eventId || (t.eventId = n.lastEventId());
                var a = xn.document.createElement("script");
                a.async = !0, a.src = function(t, n) {
                    var r = T(t),
                    ...
                    for (var o in n)
                        if ("dsn" !== o)
                            if ("user" === o) {
                                var u = n.user;
                                if (!u) continue;
                                u.name && (i += "&name=" + encodeURIComponent(u.name)), u.email && (i += "&email=" + encodeURIComponent(u.email))
                            } else i += "&" + encodeURIComponent(o) + "=" + encodeURIComponent(n[o]);
                    return e + "?" + i
                }(u, t), t.onLoad && (a.onload = t.onLoad);
    ...
    }, t.winjsStackLineParser = ur, t.withScope = on, t.wrap = function(t) {
        return Dn(t)()
    }, t
}({});
